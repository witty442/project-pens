...
function addRow(){
	...
	var rowData ="<tr class='"+className+"'>"+
	    ...
	    "  <input type='text' name='barcode' size='25' onkeyup='getProductKeypress(event,this,"+lineId+")' autocomplete='off' />"+
	    "</td>"+
										...
										<tr class="<c:out value='${tabclass}'/>">
											...
											<td class="td_text_center"  width="10%">
											    <input type="text" name="barcode" id="barcode" value ="${results.barcode}" size="25" 
												    onkeyup="getProductKeypress(event,this,${results.lineId})"
