...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<jsp:useBean id="posForm" class="com.isecinc.pens.web.pos.PosForm" scope="session" />
...
function clearForm(path){
	var form = document.posForm;
	form.action = path + "/jsp/posAction.do?do=clear2";
	form.submit();
	return true;
}
...
function exportExcel(path){
	var form = document.posForm;
	form.action = path + "/jsp/posAction.do?do=exportReport&action=newsearch";
	form.submit();
	return true;
}
...
function search(path){
	...
	form.action = path + "/jsp/posAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
...
function openEdit(path,docNo,mode,pageType){
	...
	form.action = path + "/jsp/posAction.do?do=prepare"+param;
	form.submit();
	return true;
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="bottom: 0;height: 100%;" id="maintab">
  	...
  	<tr id="framerow">
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<!-- BODY -->
						<html:form action="/jsp/posAction">
            ...
            <c:if test="${posForm.resultsSearch != null}">
						...
						<table id="tblProduct" align="center" border="0" cellpadding="3" cellspacing="1" class="tableSearch">
							...
							<c:forEach var="results" items="${posForm.resultsSearch}" varStatus="rows">
								<c:choose>
