	...
	private static Logger logger = Logger.getLogger("PENS");
	 ...
	 public static List<PopupForm> searchCustGroup(PopupForm c) throws Exception {
			...
			try {
				...
				sql.append("\n FROM ");
				sql.append("\n PENSBME_MST_REFERENCE WHERE 1=1  and reference_code = 'Idwacoal' ");
				if( !Utils.isNull(c.getCodeSearch()).equals("")){
	 ...
	 public static List<PopupForm> searchCustGroupForScan(PopupForm c) throws Exception {
			Statement stmt = null;
			ResultSet rst = null;
			List<PopupForm> pos = new ArrayList<PopupForm>();
			StringBuilder sql = new StringBuilder();
			...
			try {
				...
				//sql.append("\n and pens_value in ('020049','020047' ) ");
	 ...
	 public static List<References> searchWareHouseList() throws Exception {
			...
			try {
				...
				sql.append("\n FROM ");
				sql.append("\n PENSBME_MST_REFERENCE WHERE 1=1  and reference_code = 'Warehouse' ");
	 ...
	 public static String getStoreNameModel(Connection conn,String storeCode) throws Exception {
			...
			try {
				...
				sql.append("\n select pens_value , pens_desc  ");
				sql.append("\n FROM ");
				sql.append("\n PENSBME_MST_REFERENCE WHERE 1=1  and reference_code = 'Store' ");
