...
public class OrderDAO_BK {
	...
	public static String getOrderNoByStoreCode(Connection conn,String storeType,Date orderDate,String storeCode) throws Exception{
		PreparedStatement ps =null;
		ResultSet rs = null;
		String orderNo = "";
		try{
	...
	//	logger.debug("Update");
		try{
			...
			ps.setString(2, o.getUpdateUser()+"(upOrderNoLine)");
