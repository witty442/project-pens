...
public class AutoSubInDAO extends PickConstants{
	protected static Logger logger = Logger.getLogger("PENS");
	protected static SimpleDateFormat df = new SimpleDateFormat("yyyy/MM/dd", Utils.local_th);
	private static String priceListId = "10012";//Fix BigC
	
	public static List<AutoSubInBean> searchJobList(Connection conn,AutoSubInBean o,boolean allRec ,int currPage,int pageSize) throws Exception {
		...
		try {
		    ...
		    sql.append("\n    AND pens_value LIKE '"+o.getCustGroup()+"%' ");
			sql.append("\n  ) M ");
		    sql.append("\n   where 1=1 ");
	...
	public static AutoSubInBean searchItemListCaseNew(Connection conn,AutoSubInBean h) throws Exception {
		PreparedStatement ps = null;
		ResultSet rst = null;
		StringBuilder sql = new StringBuilder();
		try {
            sql.append("\n  select ");
			sql.append("\n   j.forwarder, j.forwarder_box");
			sql.append("\n  ,(select count(*) as c from pensbi.pensbme_pick_barcode bi ");
		    sql.append("\n  where bi.status not in ('O','AB') and bi.job_id = j.job_id group by job_id) as total_box ");
		    sql.append("\n  ,(select count(*) as c from pensbi.pensbme_pick_barcode_item bi ");
		    sql.append("\n  where bi.status not in ('O','AB') and bi.job_id = j.job_id group by job_id) as total_qty ");
		    sql.append("\n  from pensbi.pensbme_pick_job j");
		    sql.append("\n  where 1=1");
		    sql.append("\n  and j.status not in ('O','AB') ");
		    sql.append("\n  and j.job_id="+Utils.isNull(h.getJobId()));
            sql.append("\n  group by j.job_id,j.forwarder, j.forwarder_box");
			logger.debug("sql:"+sql);
	...
	public static List<AutoSubInBean> searchItemDetailListCaseNew(Connection conn,AutoSubInBean o) throws Exception {
		PreparedStatement ps = null;
		ResultSet rst = null;
		StringBuilder sql = new StringBuilder();
		AutoSubInBean h = null;
	...
	public static AutoSubInBean searchItemListCaseView(Connection conn,AutoSubInBean o) throws Exception {
		PreparedStatement ps = null;
		ResultSet rst = null;
		StringBuilder sql = new StringBuilder();
		AutoSubInBean h = null;
		...
		try {
			...
			sql.append("\n  ,h.Forwarder,h.total_box ,h.Forwarder_box");
	...
	public static int searchTotalRecJobList(Connection conn,AutoSubInBean o) throws Exception {
		PreparedStatement ps = null;
		ResultSet rst = null;
		StringBuilder sql = new StringBuilder();
		AutoSubInBean h = null;
	...
	public static StringBuffer genWhereSearchJobListStatus(AutoSubInBean o) throws Exception{
		StringBuffer sql = new StringBuffer("");
	...
	public static void save(Connection conn,AutoSubInBean head) throws Exception{
		int i=0;
	...
	public static void cancel(Connection conn,AutoSubInBean head) throws Exception{
		try{
	 ...
	 public static int insertHeadModel(Connection conn,AutoSubInBean head) throws Exception{
			PreparedStatement ps = null;
	 ...
	 public static int updateHeadModel(Connection conn,AutoSubInBean head) throws Exception{
			PreparedStatement ps = null;
			logger.debug("insertHeadModel");
			int c =1;int r = 0;
			StringBuffer sql = new StringBuffer("");
	 ...
	 public static boolean isHeadExist(Connection conn,AutoSubInBean head) throws Exception{
			PreparedStatement ps = null;
			ResultSet rs = null;
	 ...
	 public static int insertItemModel(Connection conn,AutoSubInBean head,AutoSubInBean item) throws Exception{
			PreparedStatement ps = null;
	 ...
	 public static int updateStatusItemModel(Connection conn,AutoSubInBean head) throws Exception{
			PreparedStatement ps = null;
			logger.debug("insertHeadModel");
			int c =1;int r = 0;
			StringBuffer sql = new StringBuffer("");
	 ...
	 public static int deleteItemByPK(Connection conn,AutoSubInBean head,AutoSubInBean item) throws Exception{
			PreparedStatement ps = null;
			logger.debug("insertHeadModel");
			int c =1;int r = 0;
			StringBuffer sql = new StringBuffer("");
	  ...
	  public static AutoSubInBean searchProductByPensItem(PopupForm c,String storeCode) throws Exception {
			Statement stmt = null;
			ResultSet rst = null;
			StringBuilder sql = new StringBuilder();
			Connection conn = null;
			AutoSubInBean b = null;
