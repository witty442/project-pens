...
public class ReportEndDateLotusSQL_BK {
	private static Logger logger = Logger.getLogger("PENS");
	 ...
	 public static StringBuilder genSQLByStoreCode(Connection conn,OnhandSummary c,User user,String summaryType,String typeGen) throws Exception{
			StringBuilder sql = new StringBuilder();
			//Date asofDate = null;
