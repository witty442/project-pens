 ...
 * 
 */
public class OrderAction_BK extends I_Action {
	...
	protected String search(ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if("save".equalsIgnoreCase(action)){
	                        ...
	                        if("".equals(orderNoLine)){
	                        	...
	                        	if( !"".equals(o.getQty()) && !"0".equals(o.getQty())){
		                        	...
		                        	if(mapOrderNoByStoreMap.get(o.getStoreCode()) ==null){
		                        		//get orderNo from DB second check
				...
				logger.debug("chkStoreCreditLimit:"+chkStoreCreditLimit);
	...
	protected String save(ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if(haveError == false){
				...
				/** Get OrderNoInDB key by StoreCode   **/
                mapOrderNoByStoreMap = orderDAO.getOrderNoByStoreMap(conn, orderForm.getOrder().getStoreType(),orderDate);
		        		...
		        		for(row=0;row<groupArr.length;row++ ){
	                        ...
	                        if("".equals(orderNoLine)){
	                        	...
	                        	if( !"".equals(o.getQty()) && !"0".equals(o.getQty())){
		                        	...
		                        	//Insert
		                        	logger.debug("Insert OrderNo:"+orderNo+"BarOnBox:"+barOnBox);
		                        	o.setCreateUser(user.getUserName()+"(insert)");
		                        	o.setOrderNo(orderNo);
		                        	o.setBarOnBox(barOnBox);
	                        	...
	                        	o.setOrderNo(orderNoLine);
	                        	o.setBarOnBox(barOnBoxLine);
	                        	o.setUpdateUser(user.getUserName()+"(update)");
