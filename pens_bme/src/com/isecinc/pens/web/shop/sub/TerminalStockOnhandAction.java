...
public class TerminalStockOnhandAction {
 ...
 public static StringBuffer exportToExcel(HttpServletRequest request, ShopForm form,User user,List<ShopBean> list){
		...
		try{
			...
			h.append(" <tr> \n");
			h.append("  <td align='left' colspan='"+colspan+"'><b>รายงาน Stock Onhand at Terminal21-Asok</b></td> \n");
			h.append(" </tr> \n");
			h.append(" <tr> \n");
