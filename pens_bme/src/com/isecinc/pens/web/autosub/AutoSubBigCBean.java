...
public class AutoSubBigCBean implements Serializable{
	...
	private List<AutoSubBigCBean> items;
	...
	public List<AutoSubBigCBean> getItems() {
		return items;
	}
	public void setItems(List<AutoSubBigCBean> items) {
		this.items = items;
	}
