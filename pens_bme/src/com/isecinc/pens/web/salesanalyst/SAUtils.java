...
public class SAUtils {
	...
	public static String genColDispName(String colDispName){
		String r = colDispName;
		if(colDispName.startsWith("QTY")){
			r= "จำนวนชิ้น";
		}else if(colDispName.startsWith("WHOLE_PRICE_BF")){
			r= "จำนวนเงิน(ขายส่ง) Exc.VAT(บาท)";
		}else if(colDispName.startsWith("RETAIL_PRICE_BF")){
			r= "จำนวนเงิน(ขายปลีกสุทธิ) Inc.VAT (บาท)";
		}
		return r;
	}
