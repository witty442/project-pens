...
function search(path){
	var form = document.saDamageForm;
	form.action = path + "/jsp/saDamageAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
...
function newEmp(path){
	 var form = document.saDamageForm;
	var param ="";
	form.action = path + "/jsp/saDamageAction.do?do=prepare&action=add"+param;
	form.submit();
	return true; 
}
...
function openEdit(path,empId,type,invRefwal){
	...
	form.action = path + "/jsp/saDamageAction.do?do=prepare&action=edit"+param;
	form.submit();
	return true; 
}
