...
function cancelAction(path){
	...
	if(confirm("ยืนยันยกเลิกรายการ")){
	  form.action = path + "/jsp/autoCNAction.do?do=cancelAction";
	  form.submit();
	  return true;
	}
	return false;
...
function backAction(path){
	var form = document.autoCNForm;
	form.action = path + "/jsp/autoCNAction.do?do=search2&action=back";
	form.submit();
	return true;
}
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
						    ...
						    <table align="center" border="0" cellpadding="3" cellspacing="0" >
								...
								<tr>
									...
									<td colspan="2">		
									 ...
									 &nbsp;&nbsp;RTN No  &nbsp;&nbsp; &nbsp;&nbsp;
									 <html:text property="bean.rtnNo" styleId="rtnNo" size="20"  disabled="true" styleClass="disableText"/>
									</td>
								</tr>
						   </table>
                    <!-- table data -->
	            ...
	            <table id="tblProductBtn" align="center" border="0" cellpadding="3" cellspacing="2"  width="65%">
                         <tr><td align="center">
                            ...
                            <%if(autoCNForm.getBean().isCanCancel()) { %>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
