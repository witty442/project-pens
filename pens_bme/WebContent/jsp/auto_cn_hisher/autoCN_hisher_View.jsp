						    ...
						    <table align="center" border="0" cellpadding="3" cellspacing="0" >
								<tr>
								   <td align="right">  Job Id	</td>
									<td>	
									     <html:text property="bean.jobId" styleId="jobId" size="10"   styleClass="disableText" readonly="true"/>
									</td>
                                    <td align="right">  GR NO	</td>
									<td>	
									     <html:text property="bean.grNo" styleId="grNo" size="12"   styleClass="disableText" readonly="true"/>
									</td>
									 <td align="right"> BOX NO	</td>
									<td>	
									     <html:text property="bean.boxNo" styleId="boxNo" size="15"   styleClass="disableText" readonly="true"/>
									</td>
									<td>		
						...
						<table id="tblProduct" align="center" border="0" cellpadding="3" cellspacing="2" class="tableSearchNoWidth" width="100%">
							...
							for(int n=0;n<resultList.size();n++){
								...
								<tr class="<%=tabclass%>"> 
									...
									<td class="td_text" width="15%"><%=mc.getItemName()%></td><!-- 7 -->
