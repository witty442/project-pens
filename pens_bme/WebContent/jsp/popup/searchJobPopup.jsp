...
function searchPopup(path, type) {
    document.popupForm.action = path + "/jsp/searchJobPopupAction.do?do=search";
...
<display:table width="100%" id="item" name="requestScope.JOB_LIST" 
    defaultsort="0" defaultorder="descending" requestURI="../jsp/searchJobPopupAction.do?do=search" sort="list" pagesize="20" class="resultDisp">	
