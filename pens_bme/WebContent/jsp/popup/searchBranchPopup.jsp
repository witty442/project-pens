...
function searchPopup(path, type) {
    document.popupForm.action = path + "/jsp/searchCustomerPopupAction.do?do=searchBranch";
...
<table align="center" border="0" cellpadding="0" cellspacing="2"  width="100%" class="tableHead">
    <tr height="21px" class="txt1">
		<th width="15%" >&nbsp;</th> 
		<th width="90%" ><b>ค้นหาข้อมูล Branch( <%=storeType%>)</b></th>
	</tr>
	<tr height="21px" class="txt1">
		<td width="15%" ><b>Branch ID</b>  </td>
...
<!-- RESULT -->
<display:table style="width:100%;" id="item" name="requestScope.BRANCH_LIST" 
    ...
    <display:column  style="text-align:center;" title="เลือกข้อมูล"  sortable="false" class="chk">
		...
		<input type ="hidden" name="code_temp" value="<bean:write name="item" property="branchId"/>" />
		<input type ="hidden" name="desc" value="<bean:write name="item" property="branchName"/>" />
	 </display:column>
    											    
    <display:column  title="Branch ID" property="branchId"  sortable="false" class="code"/>
    <display:column  title="Branch Name" property="branchName" sortable="false" class="desc"/>
