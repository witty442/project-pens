...
<table align="center" border="0" cellpadding="0" cellspacing="2"  width="100%"  class="tableHead" >
    <tr height="21px">
		<th width="25%" >&nbsp;</th>
		<th width="75%" ><b>ค้นหาข้อมูล SA Employee</b></th>
	</tr>
	<tr height="21px">
...
<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%" >
	<tr>
		<td align="center">
			<input type="button" name="ok" class="newPosBtnLong"  value="OK" onclick="selectOneRadio()" style="width:60px;"/>
			<input type="button" name="close" class="newPosBtnLong"  value="Close" onclick="javascript:window.close();" style="width:60px;"/>
		</td>
	</tr>
</table>
