...
function clearForm(path){
	...
	form.action = path + "/jsp/autoSubInAction.do?do=clear2";
	form.submit();
	return true;
}
function search(path){
	var form = document.autoSubInForm;
	form.action = path + "/jsp/autoSubInAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
function exportToExcel(path){
	var form = document.autoSubInForm;
	form.action = path + "/jsp/autoSubInAction.do?do=exportToExcel&action=newsearch";
	form.submit();
	return true;
}
function gotoPage(path,currPage){
	var form = document.autoSubInForm;
	form.action = path + "/jsp/autoSubInAction.do?do=search2&currPage="+currPage;
    form.submit();
    return true;
}
function openEdit(path,action,jobId,subInv,custGroup,storeCode){
	var form = document.autoSubInForm;
	...
	form.action = path + "/jsp/autoSubInAction.do?do=prepare"+param;
	form.submit();
	return true; 
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="bottom: 0;height: 100%;" id="maintab">
  	...
  	<tr id="framerow">
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
            ...
            <c:if test="${autoSubInForm.resultsSearch != null}">
                   <% 
					   int totalPage = autoSubInForm.getTotalPage();
					   int totalRecord = autoSubInForm.getTotalRecord();
					   int currPage =  autoSubInForm.getCurrPage();
					   int startRec = autoSubInForm.getStartRec();
					   int endRec = autoSubInForm.getEndRec();
					%>
					       ...
					       <tr>
							...
							for(int n=0;n<resultList.size();n++){
								...
								<tr class="<%=tabclass%>"> 
									...
									<td class="td_text" width="15%"><%=mc.getJobName()%></td><!-- 3 -->
								    <td class="td_text" width="6%"><%=mc.getStoreCode()%></td><!-- 4 -->
								    <td class="td_text" width="8%"><%=mc.getStoreName()%></td><!-- 4 -->
								    <td class="td_text_center" width="6%"><%=mc.getSubInv()%></td><!-- 5 -->
