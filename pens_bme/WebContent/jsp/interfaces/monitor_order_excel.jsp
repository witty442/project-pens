 ...
 <c:if test="${interfacesForm.results != null}">
	...
	<c:forEach var="results" items="${interfacesForm.results}" varStatus="rows">
			...
			<tr>
				...
				<td>
				<a href ="javascript:window.open('<%=request.getContextPath()%>/jsp/interfacesAction.do?do=downloadFile&monitorItemId=${results.monitorItemId}','','width=500px,height=100px')" title="Download">
				    Download File 
				</a>
				</td>
