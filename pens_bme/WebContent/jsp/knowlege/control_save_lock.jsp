...
/* $(function(){
 $('#save-dialog').dialog({
	    ...
	    width: 700,
	    height: 300,
		title:"กรุณารอสักครู่กำลังบันทึกข้อมูล.........",
		position:'center',
		resizable: false,
		position: ['center',20],
        closeOnEscape: false
...
<!-- <div id="save-dialog">
     <h1>กำลังบันทึกข้อมูล กรุณารอสักครู่</h1>
</div> -->
<!-- Progress Bar -->
    ...
    <tr>
		<td align="left" width ="100%">
		  <div style="height:50px;align:center">
		     <b>กรุณารอสักครู่ กำลังบันทึกข้อมูล ...... <br/><font color="red">!กรุณาอย่ากดปุ่ม back หรือ  Refresh </font> </b>
		  </div>
