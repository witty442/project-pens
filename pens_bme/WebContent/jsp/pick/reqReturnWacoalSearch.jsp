...
function clearForm(path){
	...
	form.action = path + "/jsp/reqReturnWacoalAction.do?do=clear2";
	form.submit();
	return true;
}
...
function search(path){
	var form = document.reqReturnWacoalForm;
	form.action = path + "/jsp/reqReturnWacoalAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
function gotoPage(path,currPage){
	var form = document.reqReturnWacoalForm;
	form.action = path + "/jsp/reqReturnWacoalAction.do?do=search2&currPage="+currPage;
    form.submit();
    return true;
}
function openEdit(path,requestDate,requestNo,mode){
	var form = document.reqReturnWacoalForm;
	form.action = path + "/jsp/reqReturnWacoalAction.do?do=prepare&requestDate="+requestDate+"&requestNo="+requestNo+"&mode="+mode;
	form.submit();
	return true;
}
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<!-- BODY -->
						<html:form action="/jsp/reqReturnWacoalAction">
