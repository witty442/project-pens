...
function clearForm(path){
	...
	form.action = path + "/jsp/confirmReturnAction.do?do=clear";
	form.submit();
	return true;
}
...
function back(path){
	var form = document.confirmReturnWacoalForm;
	form.action = path + "/jsp/confirmReturnAction.do?do=prepare2&action=back";
	form.submit();
	return true;
}
...
function exportExcel(path){
	var form = document.confirmReturnWacoalForm;
	form.action = path + "/jsp/confirmReturnAction.do?do=exportExcel";
	form.submit();
	return true;
}
						   ...
						   <div align="center">
						    <table align="center" border="0" cellpadding="3" cellspacing="0" >
						       <tr>
									...
									<td>					
										 Status 
									  <html:text property="bean.statusDesc" styleId="status" readonly="true" size="20" styleClass="disableText"/>
									</td>
								</tr>
								<tr>
                                    <td> Return Date</td>
