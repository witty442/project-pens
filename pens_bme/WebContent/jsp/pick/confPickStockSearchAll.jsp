...
function clearForm(path){
	...
	form.action = path + "/jsp/confPickStockAllAction.do?do=clear2";
	form.submit();
	return true;
}
...
function search(path){
	...
	form.action = path + "/jsp/confPickStockAllAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
...
function openView(path,documentNo,issueReqStatus,wareHouse){
	var form = document.confPickStockAllForm;
	form.action = path + "/jsp/confPickStockAllAction.do?do=prepare&mode=view&issueReqNo="+documentNo+"&issueReqStatus="+issueReqStatus+"&wareHouse="+wareHouse;
	form.submit();
	return true;
}
...
function openEdit(path,documentNo,issueReqStatus,wareHouse){
	var form = document.confPickStockAllForm;
	form.action = path + "/jsp/confPickStockAllAction.do?do=prepare&mode=edit&issueReqNo="+documentNo+"&issueReqStatus="+issueReqStatus+"&wareHouse="+wareHouse;
	form.submit();
	return true;
}
function openConfirm(path,documentNo,issueReqStatus,wareHouse){
	var form = document.confPickStockAllForm;
	form.action = path + "/jsp/confPickStockAllAction.do?do=prepare&mode=confirm&issueReqNo="+documentNo+"&issueReqStatus="+issueReqStatus+"&wareHouse="+wareHouse;
	form.submit();
	return true;
}
...
function printBillMiniAll(path){
	...
	form.action = path + "/jsp/confPickStockAllAction.do?do=printBillMiniAll";
	form.submit();
	return true;
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="bottom: 0;height: 100%;" id="maintab">
  	...
  	<tr id="framerow">
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
            ...
            <c:if test="${confPickStockAllForm.resultsSearch != null}">
						...
						<table id="tblProduct" align="center" border="0" cellpadding="3" cellspacing="1" class="tableSearchNoWidth" width="100%">
							...
							<c:forEach var="results" items="${confPickStockAllForm.resultsSearch}" varStatus="rows">
								<c:choose>
