...
<%
if(session.getAttribute("statusReqFinishList") == null){
...
function clearForm(path){
	...
	form.action = path + "/jsp/confFinishAction.do?do=clear2";
	form.submit();
	return true;
}
...
function search(path){
	var form = document.confFinishForm;
	form.action = path + "/jsp/confFinishAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}

function openEdit(path,requestNo,mode){
	var form = document.confFinishForm;
	form.action = path + "/jsp/confFinishAction.do?do=prepare&requestNo="+requestNo+"&mode="+mode;
	form.submit();
	return true;
}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="bottom: 0;height: 100%;" id="maintab">
  	...
  	<tr id="framerow">
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
            ...
            <c:if test="${confFinishForm.resultsSearch != null}">
