...
<table  border="0" cellpadding="3" cellspacing="0" class="body" width="50%">
   <tr>
	...
	<td align="left" width="6%"><html:text property="bean.startDate" styleId="startDate" readonly="true" size="10"/></td>
	<td align="right" width="6%"> ถึง วันที่ขาย</td>
	<td align="left" width="10%"><html:text property="bean.endDate" styleId="endDate" readonly="true" size="10"/></td>
  </tr>
</table>