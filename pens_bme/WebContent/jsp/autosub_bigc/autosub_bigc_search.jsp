...
function clearForm(path){
	...
	form.action = path + "/jsp/autoSubBigCAction.do?do=clear2";
	form.submit();
	return true;
}
function search(path){
	var form = document.autoSubBigCForm;
	form.action = path + "/jsp/autoSubBigCAction.do?do=search2&action=newsearch";
	form.submit();
	return true;
}
function exportToExcel(path){
	var form = document.autoSubBigCForm;
	form.action = path + "/jsp/autoSubBigCAction.do?do=exportToExcel&action=newsearch";
	form.submit();
	return true;
}
function gotoPage(path,currPage){
	var form = document.autoSubBigCForm;
	form.action = path + "/jsp/autoSubBigCAction.do?do=search2&currPage="+currPage;
    form.submit();
    return true;
}
function openEdit(path,action,jobId,subInv,custGroup,storeCode){
	...
	form.action = path + "/jsp/autoSubBigCAction.do?do=prepare"+param;
	form.submit();
	return true; 
}
  	...
  	<tr id="framerow">
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
            ...
            <c:if test="${autoSubBigCForm.resultsSearch != null}">
                   <% 
					   int totalPage = autoSubBigCForm.getTotalPage();
					   int totalRecord = autoSubBigCForm.getTotalRecord();
					   int currPage =  autoSubBigCForm.getCurrPage();
					   int startRec = autoSubBigCForm.getStartRec();
					   int endRec = autoSubBigCForm.getEndRec();
					%>
