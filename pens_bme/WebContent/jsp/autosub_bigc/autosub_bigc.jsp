...
<link rel="StyleSheet" href="${pageContext.request.contextPath}/css/field_size.css?v=<%=SessionIdUtils.getInstance().getIdSession() %>" type="text/css" />
...
function saveAction(path){
	...
	if(confirm("ยืนยันบันทึกข้อมูล")){
	  form.action = path + "/jsp/autoSubBigCAction.do?do=save";
	  form.submit();
	  return true;
	}
	return false;
...
function cancelAction(path){
	...
	if(confirm("ยืนยันยกเลิกรายการ")){
	  form.action = path + "/jsp/autoSubBigCAction.do?do=cancelAction";
	  form.submit();
	  return true;
	}
	return false;
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
                    ...
                    <!-- table data -->
                      ...
                      <%if(autoSubBigCForm.getBean().isCanSave()) { %>
	            ...
	            <table id="tblProductBtn" align="center" border="0" cellpadding="3" cellspacing="2"  width="65%">
                         <tr><td align="center">
                            ...
                            <%if(autoSubBigCForm.getBean().isCanCancel()) { %>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
