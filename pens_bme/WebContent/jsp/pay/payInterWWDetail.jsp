<%@page import="com.isecinc.pens.web.pay.PayInterWWForm"%>
...
function loadMe(path){
	...
	document.getElementsByName('bean.deptId')[0].value = '${payInterWWForm.bean.deptId}';
	
	loadSection();
	<%if( !"".equals(payInterWWForm.getBean().getSectionId())){ %>
	  document.getElementsByName('bean.sectionId')[0].value = <%=payInterWWForm.getBean().getSectionId()%>;
	<% } %>
...
function clearForm(path){
	...
	form.action = path + "/jsp/payInterWWAction.do?do=clear";
	form.submit();
	return true;
}
...
function back(path){
	var form = document.payInterWWForm;
	form.action = path + "/jsp/payInterWWAction.do?do=prepare2&action=back";
	form.submit();
	return true;
}
...
function save(path){
	var form = document.payInterWWForm;
	form.action = path + "/jsp/payInterWWAction.do?do=save&action=newsearch";
	form.submit();
	return true;
}
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<jsp:include page="../error.jsp"/>
						   ...
						   <table id="tblProduct" align="center" width="75%" border="0" cellpadding="3" cellspacing="2" class="tableSearchNoWidth">
							...
							PayInterWWForm pay = (PayInterWWForm) session.getAttribute("payInterWWForm");
						 ...
						 <%--  <table id="tblProduct" align="center" width="75%" border="0" cellpadding="3" cellspacing="2" class="tableSearchNoWidth">
						   ...
						   <table  border="0" cellpadding="3" cellspacing="0" >
								<tr>
									<td align="left">
									 <c:if test="${payInterWWForm.bean.canPrint == true}"> 
