...
public class RequisitionProductCatalog implements Comparable{
	...
	public int compareTo(Object o) {
		if (!(o instanceof RequisitionProductCatalog))
		      throw new ClassCastException();

		RequisitionProductCatalog catalog = (RequisitionProductCatalog) o;
