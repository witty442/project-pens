 ...
 * 
 */
public class OrderSpecialForm extends I_Form {

	private static final long serialVersionUID = -427868075358525185L;

	private OrderSpecialCriteria criteria = new OrderSpecialCriteria();
	...
	public OrderSpecialCriteria getCriteria() {
		return criteria;
	}

	public void setCriteria(OrderSpecialCriteria criteria) {
