...
public class OrderSpecialUtils {
	...
	public static boolean canPrintBillCreditCaseVan(User user,String orderNo){
		Connection conn = null;
		try{
			conn = DBConnection.getInstance().getConnection();
			if(ControlCode.canExecuteMethod("OrderUtils", "canPrintBillCreditCaseVan")){
			   return canPrintBillCreditCaseVanModel(conn, user, orderNo);
			}
		}catch(Exception e){
			logger.error(e.getMessage(),e);
		}finally{
	...
	public static boolean canPrintBillCreditCaseVanModel(Connection conn,User user,String orderNo){
		boolean canSave = true;
		PreparedStatement ps = null;
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer("");
