...
public class StockPD {
	...
	private List<StockPDLine> stockPDLineList;
	...
	public List<StockPDLine> getStockPDLineList() {
		return stockPDLineList;
	}


	public void setStockPDLineList(List<StockPDLine> stockPDLineList) {
		this.stockPDLineList = stockPDLineList;
	}
