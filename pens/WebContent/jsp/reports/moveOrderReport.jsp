...
function gotoReport(path){
	...
	document.moveOrderReportForm.action = path + "/jsp/moveOrderReportAction.do?do=searchReport&rf=Y";
	document.moveOrderReportForm.submit();
	return true;
}

function clearForm(path){
	document.moveOrderReportForm.action = path + "/jsp/moveOrderReportAction.do?do=clearForm";
	document.moveOrderReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="MoveOrderReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/moveOrderReportAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right">วันที่เริ่มต้่น<font color="red">*</font> :<html:text property="moveOrderReport.orderDateFrom" styleId="orderDateFrom" readonly="true" size="15"/></td>
								<td align="left">
								     วันที่สิ้นสุด <font color="red">*</font>:<html:text property="moveOrderReport.orderDateTo" styleId="orderDateTo" readonly="true" size="15"/>
								</td>
							</tr>
