...
<jsp:useBean id="shipmentBenecolReportForm" class="com.isecinc.pens.web.report.shipmentbenecol.ShipmentBenecolReportForm" scope="request" />
<%
...
function loadMe(){
	new Epoch('epoch_popup','th',document.getElementById('shippingDate'));
}
...
function gotoReport(path){
	...
	document.shipmentBenecolReportForm.action = path + "/jsp/shipmentBenecolAction.do?do=searchReport&rf=Y";
	document.shipmentBenecolReportForm.submit();
	return true;
}

function clearForm(path){
	document.shipmentBenecolReportForm.action = path + "/jsp/shipmentBenecolAction.do?do=clearForm";
	document.shipmentBenecolReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ShipmentBenecolToMember"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/shipmentBenecolAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								     <html:text property="shipmentBenecolReport.shippingDate" styleId="shippingDate" readonly="true" size="15"/>
								</td>
							</tr>
							<tr>
