...
function gotoReport(path){
	...
	document.performanceReportForm.action = path + "/jsp/performanceReportAction.do?do=searchReport&rf=Y";
	document.performanceReportForm.submit();
	return true;
}

function clearForm(path){
	document.performanceReportForm.action = path + "/jsp/performanceReportAction.do?do=clearForm";
	document.performanceReportForm.submit();
	return true;
}
</script>
	    	...
	    	<!-- PROGRAM HEADER -->
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/performanceReportAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								     <html:text property="performanceReport.orderDate" styleId="orderDate" readonly="true" size="15"/>
								</td>
							</tr>
							<tr>
