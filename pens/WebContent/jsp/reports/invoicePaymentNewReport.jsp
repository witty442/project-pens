...
function gotoReport(path){
	...
	document.invoicePaymentNewReportForm.action = path + "/jsp/invoicePaymentNewReportAction.do?do=searchReport&rf=Y";
	document.invoicePaymentNewReportForm.submit();
	return true;
}

function clearForm(path){
	document.invoicePaymentNewReportForm.action = path + "/jsp/invoicePaymentNewReportAction.do?do=clearForm";
	document.invoicePaymentNewReportForm.submit();
	return true;
}
</script>
	    	...
	    	<!-- PROGRAM HEADER -->
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/invoicePaymentNewReportAction">
