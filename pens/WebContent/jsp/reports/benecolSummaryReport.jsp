...
function search(path){
	...
	document.benecolSummaryForm.action = path + "/jsp/benecolSummaryReportAction.do?do=searchReport&rf=Y";
	document.benecolSummaryForm.submit();
	return true;
}

function clearForm(path){
	document.benecolSummaryForm.action = path + "/jsp/benecolSummaryReport.do";
	document.benecolSummaryForm.submit();
	return true;
}
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="BenecolSummaryReport" />
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY --> 
						<form name="benecolSummaryForm" method="post">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right">
									<bean:message key="DateFrom" bundle="sysele"/>
									<font color="red">*</font>
								</td>
								<td align="left">
							...
							<tr>
								<td align="center" colspan="2">
									<input type="radio" name="reportType" value="S" checked="checked">Summary Report
									<input type="radio" name="reportType" value="D">Detail Report
								</td>
							</tr>
						</table>
						<br>
