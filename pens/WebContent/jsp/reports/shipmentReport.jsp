...
<jsp:useBean id="shipmentReportForm" class="com.isecinc.pens.web.report.shipment.ShipmentReportForm" scope="request" />
<%
...
function gotoReport(path){
	...
	document.shipmentReportForm.action = path + "/jsp/shipmentReportAction.do?do=searchReport&rf=Y";
	document.shipmentReportForm.submit();
	return true;
}

function clearForm(path){
	document.shipmentReportForm.action = path + "/jsp/shipmentReportAction.do?do=clearForm";
	document.shipmentReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="HeartiBenecolShipment"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/shipmentReportAction">
