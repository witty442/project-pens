...
<td><input name="qty1" type="text" class="qtyInput" height="50" onkeydown="return inputNum(event);" onblur="linePrice('<%=rowNo%>','<%=catalog.getPrice1()%>','<%=catalog.getPrice2()%>')" value="<%=qty1%>" />&nbsp;&frasl;&nbsp;
	<input name="qty2" type="text" class="qtyInput" height="50" <%=disable%> onkeydown="return inputNum(event);" onblur="linePrice('<%=rowNo%>','<%=catalog.getPrice1()%>','<%=catalog.getPrice2()%>')" value="<%=qty2%>" />
</td>
