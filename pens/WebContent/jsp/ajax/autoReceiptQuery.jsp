...
<td align="center" style="display: none;">
	<input type="text" name="receiptAmount" size="10" maxlength="20" readonly="readonly" class="disableText" style="text-align: right;" onkeydown="return isNum0to9andpoint(this, event);"/>
</td>
<td align="left">
	<select name="bank">
		<option value=""></option>
...
<td align="center"><input type="text" name="chequeDate" id="chqDate_<%=rowseed %>" size="15" readonly="readonly" maxlength="10"/></td>
<td align="center">
...
<td align="center">
	<input type="text" name="paidAmount" size="10" maxlength="20" style="text-align: right;" onkeydown="return isNum0to9andpoint(this, event);"/>
</td>
