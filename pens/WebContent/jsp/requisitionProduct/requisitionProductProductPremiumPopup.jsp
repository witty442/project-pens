...
function loadMe(){
	...
	$('#pricelistId').val(cdoc.getElementsByName('requisitionProduct.priceListId')[0].value);
	if('<%=row%>'!='')
	{
		putData(<%=row%>);
	}
...
function loadProductOnKeyPress(e){
	//alert(e.keyCode);
	if ( (e != null && e.keyCode == 13) || (e != null && e.keyCode == 9) ){
		//alert("onKeyPress");
...
function loadProductModel(e){
		...
		$(function(){
			var getData = $.ajax({
				url: "${pageContext.request.contextPath}/jsp/ajax/productPremiumQueryOrder.jsp",
				...
				success: function(getData){
					...
					var getData2 = $.ajax({
						url: "${pageContext.request.contextPath}/jsp/ajax/UOMProductPremiumQuery.jsp",
...
<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
	...
	<tr>
		...
		<td align="left">
			<input type="text" id="pCode" name="pCode"  onkeypress="" ONKEYDOWN="loadProductOnKeyPress(event);"  tabindex="1" />&nbsp;
