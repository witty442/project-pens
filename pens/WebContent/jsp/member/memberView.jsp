						...
						<jsp:include page="../error.jsp"/>
							<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
									...
									<table id="tblAddress" align="left" border="0" cellpadding="3" cellspacing="0" width="100%" class="result">
										<tbody>
											<c:forEach var="address1" items="${memberForm.addresses}" varStatus="rows1">
												...
												<tr onmouseover="show_edit_address(${rows1.index+1});" onmouseout="hide_edit_address(${rows1.index+1});"
													style="cursor: pointer; cursor: hand;" class="<c:out value='${tabclass}'/>">
													<td align="left">
														${address1.lineString} 
								...
								<tr>
									...
									<td colspan="3">
										<table id="tblContact" align="left" border="0" cellpadding="3" cellspacing="1" width="100%" class="result">
											...
											<tr onmouseover="show_edit_contact(${rows2.index+1});" onmouseout="hide_edit_contact(${rows2.index+1});" style="cursor: pointer; cursor: hand;" class="<c:out value='${tabclass}'/>">
								...
								<tr>
									...
									<td align="left">
										<html:select property="member.paymentMethod" disabled="true" styleClass="disableText">
											<html:options collection="paymentmethods" property="key" labelProperty="name" />
										</html:select>
									</td>
									<td align="right">วันหมดอายุบัตรเครดิต&nbsp;&nbsp;</td>
									<td align="left">
										<html:text property="member.creditcardExpired" maxlength="5" size="5" readonly="true" styleClass="disableText"/>
									</td>
								</tr>
								<tr>
							...
							<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
								<tr>
									<td align="center">
									<%if(isExpire){ %>
										<input type="button" value="ต่ออายุ" class="newTrxBtn" onclick="open_renew('${pageContext.request.contextPath}', '${memberForm.member.id}', 'search');"/>
									<%}else{ %>
									...
									<input type="button" value="ประวัติการต่ออายุ" class="newTrxBtn"/></a>
