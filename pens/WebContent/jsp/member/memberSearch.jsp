		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" class="body" width="100%">
							...
							<tr>
								...
								<td align="left"><html:text property="member.code"/></td>
							</tr>
							<tr>
						...
						&nbsp;<span class="searchResult">${memberForm.criteria.searchResult}</span>&nbsp;<bean:message key="Records"  bundle="sysprop"/></div>
