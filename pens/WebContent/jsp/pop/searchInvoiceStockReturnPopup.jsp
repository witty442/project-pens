...
<html:hidden property="page" value="INVOICE_STOCK_RETURN"/>
...
<table align="center" border="0" cellpadding="0" cellspacing="2"  width="100%" class="tableHead">
    <tr height="21px" class="headTitle">
		<td width="100%" colspan="2" align="center"><b>ค้นหาข้อมูล จำนวนหีบคงเหลือในบิลที่สามารถคืนได้ (ใบอนุมัติให้คืนคลัง PENS รอทำลาย)</b></td>
	</tr>
...
<display:table  id="item" name="requestScope.INVOICE_LIST" 
    ...
    <display:column  title="จำนวนหีบคงเหลือในบิล" property="priAllQty"  sortable="false" class="desc"/>	
