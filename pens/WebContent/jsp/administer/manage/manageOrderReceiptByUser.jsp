...
%> 
<jsp:useBean id="manageOrderReceiptByUserForm" class="com.isecinc.pens.web.admin.ManageOrderReceiptByUserForm" scope="request" />
...
function search(){
	...
	document.manageOrderReceiptByUserForm.action='${pageContext.request.contextPath}/jsp/manageOrderReceiptByUserAction.do?do=search';
	document.manageOrderReceiptByUserForm.submit();
}

function clearForm(){
	window.location = '${pageContext.request.contextPath}/jsp/manageOrderReceiptByUser.do';
}

function cancelOM(id){
	if(!confirm('การยกเลิกรายการขาย จะยกเลิกรายการรับชำระของรายการขายนี้ด้วย\r\nท่านแน่ใจหรือไม่?')){return false;}
	document.manageOrderReceiptByUserForm.action='${pageContext.request.contextPath}/jsp/manageOrderReceiptByUserAction.do?do=save&type=OM&id='+id;
	document.manageOrderReceiptByUserForm.submit();
}

function cancelRR(id){
	if(!confirm('ต้องการยกเลิกรายการรับชำระนี้\r\nท่านแน่ใจหรือไม่?')){return false;}
	document.manageOrderReceiptByUserForm.action='${pageContext.request.contextPath}/jsp/manageOrderReceiptByUserAction.do?do=save&type=RR&id='+id;
	document.manageOrderReceiptByUserForm.submit();
}
</script>
</head>
	    	...
	    	<!-- PROGRAM HEADER -->
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/manageOrderReceiptByUserAction">
						...
						<div align="left" class="recordfound">&nbsp;&nbsp;&nbsp;
							<bean:message key="RecordsFound" bundle="sysprop" />&nbsp;<span class="searchResult"><%=manageOrderReceiptByUserForm.getOrderSize()+manageOrderReceiptByUserForm.getReceiptSize() %></span>&nbsp;<bean:message key="Records" bundle="sysprop" />
						</div>
						<!-- ORDER -->
						<%if(manageOrderReceiptByUserForm.getOrderSize()>0){ %>
						<table align="center" border="0" cellpadding="3" cellspacing="1" class="result">
							<tr>
								...
								<td class="footerNoAlign" align="right">
									<span class="searchResult"><%=manageOrderReceiptByUserForm.getOrderSize() %></span>&nbsp;<bean:message key="Records" bundle="sysprop" />
								</td>
							</tr>
							<tr>
						...
						<%} %>
						<%if(manageOrderReceiptByUserForm.getReceipts().size()>0){ %>
						<br>
						<table align="center" border="0" cellpadding="3" cellspacing="1" class="result">
							<tr>
								<td colspan="5" class="footer" align="left">
								...
								<td class="footerNoAlign" align="right">
									<span class="searchResult"><%=manageOrderReceiptByUserForm.getReceiptSize() %></span>&nbsp;<bean:message key="Records" bundle="sysprop" />
								</td>
							</tr>
							<tr>
								<th class="order"><bean:message key="No" bundle="sysprop"/></th>
							...
							<%int i=1; %>
							<%for(Receipt o : manageOrderReceiptByUserForm.getReceipts()){ %>
							<tr class="lineO">
								<td><%=i++ %></td>
