...
function getLocation(path){
	...
	window.open(path+"/jsp/location/findLocationByGPS.jsp?run=new&customerName="+customerName, "Find Location", "width="+width+",height="+height+",location=No,resizable=No");
}
