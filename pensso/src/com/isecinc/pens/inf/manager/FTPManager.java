...
public class FTPManager {
	 ...
	 * @throws Exception
	 */
	public int downloadFileMappingToTableBudsSales(User user,LinkedHashMap<String,TableBean> controlTableMap ,String path,User userBean,String transType,boolean importAll) throws Exception
	{
		FTPClient ftp = null;
		String ftpResponse = "";
		int i = 0;
...
public void uploadImageByFileName(String ftpFilePath,String localFile) throws Exception{
	...
	private void uploadCustomerLocationAllFileToFTP_OPT2_BY_FILE(User userBean,TableBean tableBean,StringBuffer dataExportSt) throws Exception{
		FTPClient ftp = null;
		String reply = "";
		Writer w = null;
		OutputStream out = null;
