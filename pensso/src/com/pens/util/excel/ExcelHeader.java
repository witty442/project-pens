...
public class ExcelHeader {
	...
	static{
		...
		EXCEL_HEADER.append(" .report_head{ \n");
		EXCEL_HEADER.append("   font-size: 25px; \n");
		...
		EXCEL_HEADER.append(" .colum_head_hilight{ \n");
		EXCEL_HEADER.append("   background-color: #D7DBDD; \n");
		EXCEL_HEADER.append("   font-weight: bold; \n");
		EXCEL_HEADER.append(" } \n");
		
		EXCEL_HEADER.append(" .colum_head_underline{ \n");
		EXCEL_HEADER.append("   font-weight: bold; \n");
		EXCEL_HEADER.append("   text-decoration: underline; \n");
		EXCEL_HEADER.append(" } \n");
		...
		EXCEL_HEADER.append(" .num_bold_underline { \n");
		EXCEL_HEADER.append("  mso-number-format:General; \n");
		EXCEL_HEADER.append("  font-weight: bold; \n");
		EXCEL_HEADER.append("  text-decoration: underline; \n");
		EXCEL_HEADER.append(" } \n");
		...
		EXCEL_HEADER.append(" .text_center{ \n");
		EXCEL_HEADER.append("   mso-number-format:'"+a+"'; \n");
		EXCEL_HEADER.append("   text_align:center; \n");
		EXCEL_HEADER.append(" } \n");
