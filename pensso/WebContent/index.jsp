...
function loadMe(){
	...
	if( isPC==false){
		 // alert("mobile");
		 window.location = "${pageContext.request.contextPath}/indexMobile.jsp?gotoPage=<%=gotoPage%>";
	}else{
		 window.location = "${pageContext.request.contextPath}/indexPC.jsp?gotoPage=<%=gotoPage%>";
	}
