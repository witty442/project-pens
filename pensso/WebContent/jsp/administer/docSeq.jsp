...
<script language = "javascript" src = "${pageContext.request.contextPath}/js/docseq.js?v=<%=SIdUtils.getInstance().getIdSession()%>"></script>
<script language = "javascript" src = "${pageContext.request.contextPath}/js/input.js?v=<%=SIdUtils.getInstance().getIdSession()%>"></script>
</head>
