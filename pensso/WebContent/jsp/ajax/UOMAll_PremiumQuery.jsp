...
try{
	if(pID != null && pID.length()>0 ){
		...
		System.out.println("Product Normal sql:\n"+sql);
		...
		if(productPremium){
			...
			System.out.println("ProductPremium sql:\n"+sqlPremium);
			
			stmt = conn.createStatement();
			rst = stmt.executeQuery(sqlPremium);
			product = new MProduct().find(pID);
