...
function gotoReport(path){
	document.creditPaidReportForm.action = path + "/jsp/creditPaidReport.do?do=searchReport&rf=Y";
	document.creditPaidReportForm.submit();
	return true;
}

function clearForm(path){
	document.creditPaidReportForm.action = path + "/jsp/creditPaidReport.do?do=clearForm";
	document.creditPaidReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="CreditPaidReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/creditPaidReport">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right">ประจำเดือน<font color="red">*</font> </td>
								<td align="left">
								   <html:select property="bean.month">
								   <html:options collection="monthList" property="key" labelProperty="name"/>
								  </html:select> 
								</td>
							</tr>
