...
<jsp:useBean id="shipmentTempReportForm" class="com.isecinc.pens.web.report.shipmenttemp.ShipmentTempReportForm" scope="request" />
<%
...
function loadMe(){
	new Epoch('epoch_popup','th',document.getElementById('shipmentDate'));
}
...
function gotoReport(path){
	...
	document.shipmentTempReportForm.action = path + "/jsp/shipmentTempReportAction.do?do=searchReport&rf=Y";
	document.shipmentTempReportForm.submit();
	return true;
}

function clearForm(path){
	document.shipmentTempReportForm.action = path + "/jsp/shipmentTempReportAction.do?do=clearForm";
	document.shipmentTempReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="HeartiBenecolShipmentTemp"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/shipmentTempReportAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								     <html:text property="shipmentTempReport.shipmentDate" styleId="shipmentDate" readonly="true" size="15"/>
								</td>
							</tr>
							<tr>
