...
<jsp:useBean id="remittanceReportForm" class="com.isecinc.pens.web.report.remittance.RemittanceReportForm" scope="request" />
<%
...
function gotoReport(path){
	...
	document.remittanceReportForm.action = path + "/jsp/remittanceReportAction.do?do=searchReport&rf=Y";
	document.remittanceReportForm.submit();
	return true;
}

function clearForm(path){
	document.remittanceReportForm.action = path + "/jsp/remittanceReportAction.do?do=clearForm";
	document.remittanceReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="Remittance"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/remittanceReportAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left" width="12%">
								     <html:text property="remittanceReport.receiptDateFrom" styleId="receiptDateFrom" readonly="true" size="15"/>
								</td>
								<td align="right" width="3%"><bean:message key="To" bundle="sysele"/></td>
								<td align="left">
								     <html:text property="remittanceReport.receiptDateTo" styleId="receiptDateTo" readonly="true" size="15"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" width="12%">
								     <html:text property="remittanceReport.customerCodeFrom"   size="15"/>
								</td>
								<td align="right" width="3%"><bean:message key="To" bundle="sysele"/></td>
								<td align="left">
								     <html:text property="remittanceReport.customerCodeTo"  size="15"/>
								</td>
							</tr>
