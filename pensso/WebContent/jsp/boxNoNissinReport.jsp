 ...
 function linkModelSub(url){
	  var newUrl ;
 	  var pathRedirect = url.substring(url.indexOf("jsp")-1,url.length);
 	   ...
 	   PopupCenterFull(encodeURI(url),"Stock Van Sales");
  }
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<%-- <jsp:include page="program.jsp">
				<jsp:param name="function" value="Blank"/>
			</jsp:include> --%>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						 <div align="center">
							<table  border="0" cellpadding="3" cellspacing="0" >
							  <tr>
								<td align="center"  colspan="2">
								  <font size="3">
								    <b>ใบปะหน้ากล่อง ของเสีย(Nissin)</b>
								  </font>
								</td>
								</tr>
								<tr>
								...
								<tr>
									<td align="left" colspan="2">
						            	<a href="#" onclick="javascript:link('<%=contextPathServerCross%>/jsp/boxNoAction.do?do=prepare&action=new');">
						                    <input type="button" value="ใบปะหน้ากล่อง ของเสีย(Nissin)" class="newPosBtnLong" style="width: 250px;"> 
								        </a>
									</td>
								</tr>
								<tr>
							...
							<br/>
				             <font color="blue" size="6"><b>!!!  รายการนี้ จะต้องเชื่อมต่อ VPN ก่อนทุกครั้ง  !!!</b></font>
				             <br/>
