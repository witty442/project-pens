    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
		     <jsp:include page="../program.jsp">
				<jsp:param name="function" value="BILLT_INCOMPLETE"/>
			</jsp:include>
			<!-- Hidden Field -->
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<div align="center">
						   	<!--  Criteria -->
						     <jsp:include page="criteria/billPlanCriteria.jsp" flush="true"/> 
					    
					 	    <!-- ************************Result *************-->
					 	     <jsp:include page="result/billPlanResult.jsp"  flush="true"/> 
					 	</div>
