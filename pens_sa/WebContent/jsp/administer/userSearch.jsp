		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="1" class="result">
							<tr>
								...
								<th class="code"><bean:message key="User.Group"  bundle="sysele"/></th>
								<th class="code">วันที่เริ่มต้น</th>
								<th class="code">วันที่สิ้นสุด</th>
							...
							<tr class="<c:out value='${tabclass}'/>">
								...
								<td align="left">${results.userGroupName}</td>
								<td align="center">${results.startDate}</td>
								<td align="center">${results.endDate}</td>
