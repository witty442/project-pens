	    	 ...
	    	 <!-- PROGRAM HEADER -->
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/roleAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								       <html:text property="role.roleColumnAccess" size="30"/>
								</td>
							</tr>
							<tr>
								<td align="right">ประเภทข้อมูลย่อย&nbsp;&nbsp;</td>
								<td align="left">
								       <html:text property="role.roleDataAccess" size="30"/>
								</td>
							</tr>
						</table>
						<br>
