...
SessionUtils.clearSessionUnusedForm(request, "vanForm");
/** Count Visit Page */
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<div align="center">
						       ...
						       <jsp:include page="criteria/orderVanVOCriteria.jsp" flush="true"/>  
					        <%} %>
					        
					 	    <!-- Result -->
					 	    <%if(VanAction.PAGE_ORDER_VAN_VO.equalsIgnoreCase(pageName)){   
					 	          if(request.getAttribute("vanForm_RESULT") != null){
					 	        	  out.println( ((StringBuffer)request.getAttribute("vanForm_RESULT")).toString());
					 	          }
					 	     }
					 	    %>
					 	</div>
