...
System.out.println("brand:"+brand+",priceListId:"+priceListId+",period:"+period+",custCatNo:"+custCatNo+",customerId:"+customerId+",salesrepId:"+salesrepId+",itemCode:"+itemCode);
