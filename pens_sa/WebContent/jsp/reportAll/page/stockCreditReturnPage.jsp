...
function exportReport(){
	...
	if(form.startDate.value =="" || form.endDate.value ==""){
	 ...
	 var path = document.getElementById("path").value;
	form.action = path + "/jsp/reportAllAction.do?do=exportReport&action=newsearch";
	form.submit();
	return true;
}
function printReport(requestNo){
	var form = document.reportAllForm;
	var path = document.getElementById("path").value;
	form.action = path + "/jsp/reportAllAction.do?do=printReport&requestNo="+requestNo;
	form.submit();
	return true;
}
