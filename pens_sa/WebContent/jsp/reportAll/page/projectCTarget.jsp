...
function chkSearch(){
   var typeSearch = document.getElementsByName("bean.projectCBean.typeSearch")[0];
   //alert(typeSearch.value);
	//disabledObj(document.getElementsByName("bean.projectCBean.day")[0] ,false);
	//disabledObj(document.getElementsByName("bean.projectCBean.dayTo")[0] ,false);
	
	var monthList = document.getElementsByName("bean.projectCBean.chkMonth");
	for(i=0;i<monthList.length;i++){
       disabledObj(document.getElementsByName("bean.projectCBean.chkMonth")[i],false);
    }
	
   if(typeSearch.value == 'DAY'){
	   for(i=0;i<monthList.length;i++){
	      disabledObj(document.getElementsByName("bean.projectCBean.chkMonth")[i],true);
	   }
	   
    }else  if(typeSearch.value == 'MONTH'){
      // disabledObj(document.getElementsByName("bean.projectCBean.day")[0] ,true);
      // disabledObj(document.getElementsByName("bean.projectCBean.dayTo")[0] ,true);
    }
}
				    	...
				    	<table align="center" border="0" cellpadding="3" cellspacing="0" >
					       <tr>
								...
								<td>					
								    ...
								    <html:select property="bean.projectCBean.typeSearch" onchange="chkSearch()" styleClass="txt_style">
								     ...
								     <fieldset>
									    ...
									    <c:forEach var="item" items="${yearList}" >
                                         <tr id="${item.key}" class="txt_style" >
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}01</html:multibox>&nbsp;ม.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}02</html:multibox>&nbsp;ก.พ.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}03</html:multibox>&nbsp;มี.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}04</html:multibox>&nbsp;เม.ย.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}05</html:multibox>&nbsp;พ.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}06</html:multibox>&nbsp;มิ.ย.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}07</html:multibox>&nbsp;ก.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}08</html:multibox>&nbsp;ส.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}09</html:multibox>&nbsp;ก.ย.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}10</html:multibox>&nbsp;ต.ค.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}11</html:multibox>&nbsp;พ.ย.</td>
                                          <td width="5%"><html:multibox  property="bean.projectCBean.chkMonth">${item.key}12</html:multibox>&nbsp;ธ.ค.</td>
                                         </tr>
                                         </c:forEach>
                                       </table>
                                       </fieldset>
