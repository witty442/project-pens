...
<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%" bgcolor="#F1F1F1">
	<tr>
		<td align="left">
			<input type="button" name="ok" value=" OK " class="newPosBtn1"  onclick="selectData()" style="width:80px;"/>
...
<%if(session.getAttribute("VALUE_LIST") != null){ %>
	 <display:table style="width:100%;" id="item" name="sessionScope.VALUE_LIST" defaultsort="0"  defaultorder="descending" class="resultDisp" requestURI="#" sort="list" pagesize="20">
	   ...
	   <display:column style="align:left;white-space:nowrap"  title="รหัส" class="code">
	      <span ondblclick="selectOneByDoubleClick(${item.no})">[ <bean:write name="item" property="code"/>]</span>
	       
	   </display:column>
	    <display:column style="align:left;white-space:nowrap"  title="รายละเอียด" class="desc">
	       <span ondblclick="selectOneByDoubleClick(${item.no})"> <bean:write name="item" property="name"/></span>
	   </display:column>
	</display:table>
<%} %>
<!-- RESULT -->
