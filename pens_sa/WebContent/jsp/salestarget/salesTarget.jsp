...
function exportToExcel(path){
	var form = document.salesTargetForm;
	form.action = path + "/jsp/salesTargetAction.do?do=exportToExcel&subPageName=DETAIL";
	form.submit();
	return true;
}
function rejectRow(path,id,lineId,rowId){
	var rejectReason = document.getElementsByName("rejectReason")[rowId-1];
	var status = document.getElementsByName("status")[rowId-1];
	//alert(rejectReason);
	var returnString = "";
	var param = "id="+id+"&lineId="+lineId;
	...
	if(reasonPrompt != null){
		...
		var getData = $.ajax({
				url: path+"/jsp/ajax/salesRejectRowAjax.jsp",
						    ...
						    <table align="center" border="0" cellpadding="3" cellspacing="0" >
						       <tr>
								...
								<tr>
                                    <td> ภาคการขาย</td>
									<td colspan="3">
									    <html:select property="bean.salesChannelNo" styleId="salesChannelNo" styleClass="disableText" disabled="true">
								...
								<tr>
                                    <td> รหัสร้านค้า</td>
									<td colspan="3">
									   <html:text property="bean.customerCode" styleId="customerCode" size="20" readonly="true" styleClass="disableText"/>
									    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									    ชื่อร้านค้า
