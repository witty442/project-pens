...
<%
String detailType = locationForm.getDetailType();
%>
<html>
<head>
...
function backForm(path){
	 document.locationForm.action = path + "/jsp/locationAction.do?do=prepare&action=back";
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" class="body"  width="100%">
							<tr>
								<td align="center" width="80%">
									<%-- <input type="button" value="Export" class="newPosBtnLong" onclick="exportDetailReport('${pageContext.request.contextPath}')">  --%>
									<input type="button" value="ปิดหน้าจอนี้" class="newPosBtnLong" onclick="backForm('${pageContext.request.contextPath}')">
								</td>
							</tr>
						</table>
					<!-- Hidden Field -->
