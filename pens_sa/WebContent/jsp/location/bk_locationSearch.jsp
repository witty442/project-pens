...
select#storeType option[value="A"] { background-image:url("${pageContext.request.contextPath}/icons/blueflagicon.png"); }
select#storeType option[value="B"] { background-image:url("${pageContext.request.contextPath}/icons/generalshop.png"); }
								...
								<tr><td colspan="8" align="right">
									...
									<tr class="txt_style" >
								  	<td width="15%" align="left">
							             ...
							             &nbsp;
							             <html:select property="bean.storeType" styleId="storeType" styleClass="txt_style">
								            <html:option value="">ร้านค้าทั้งหมด</html:option>
								            <html:option value="A">ร้านโชห่วย</html:option>
