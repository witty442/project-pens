...
<!--			</li>-->
			<%} %>
			<li>
	          <a href="#" class="parent" onclick="window.location='${pageContext.request.contextPath}/jsp/salesAnalyst/sales_analyst.jsp?action=new';"><span><bean:message key="SalesAnalysis" bundle="sysprop"/></span></a>
	       </li>
		</ul>
	</li>
