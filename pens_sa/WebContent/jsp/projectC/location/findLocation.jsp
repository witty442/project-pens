  ...
  <body>
    ...
    function noLocation() {
    	//document.getElementById("location").value="not found";
   		//$('#spnWait').hide();
   		alert("ไม่สามารถ ค้นหาตำแหน่งได้");
    }
    
    function saveLocationStore(){
    	 ...
    	 //save Ajax
    	 var getData = $.ajax({
				url: "${pageContext.request.contextPath}/jsp/projectC/ajax/saveStoreLocationAjax.jsp",
				data : param,
				async: false,
				cache: false,
    	 ...
    	 if(returnString != ""){
    	    ...
    	    window.opener.setLocationStoreValue([<%=index%>],lat,lng);
    	    window.close();
    	 }
    }
	    ...
	    <div id="div" align="center">
		    ...
		    <tr>
		        <th>
				    ...
				    <input type="button" value="ยืนยันตำแหน่งร้านค้านี้ "  onclick="saveLocationStore() " class="newPosBtnLong"/>
		        </th>
		     </tr>
		    </table>
	     </div>
