	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<!-- BODY -->
						<html:form action="/jsp/promotionAction">
						<jsp:include page="../error.jsp"/>
						<div align="center">
						    <!--  Error Log-->
						    <%if(session.getAttribute("ERROR_MSG") != null){ %>
						    <%  out.println((String)session.getAttribute("ERROR_MSG")); %>
						    <% } %>
						   	<!--  Criteria -->
						    <jsp:include page="criteria/promotionCriteria.jsp" />  
					    
					 	    <!-- ************************Result *************-->
					 	    <jsp:include page="result/promotionResult.jsp" />  
					 	</div>
					</html:form>
					<!-- BODY -->
					</td>
