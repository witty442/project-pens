				...
				%>
			        <%=PageingGenerate.genPageing(user,totalPage, totalRecord, currPage, startRec, endRec, no) %>
						...
						<div class="container">
						   <!-- Head Table -->
						   <div class="row mb-1">
						     <div class="col-1 themed-grid-col">แก้ไข/ดู</div>
						     <div class="col-1 themed-grid-col">Selected</div>
						     <div class="col-1 themed-grid-col">No</div>
					         <div class="col-1 themed-grid-col">วันที่ตรวจนับสต๊อก</div>
					         <div class="col-1 themed-grid-col">ห้าง</div>
					         <div class="col-2 themed-grid-col">ชื่อห้าง</div>
					         <div class="col-2 themed-grid-col">สาขา</div>
					         <div class="col-1 themed-grid-col">ผู้บันทึกตรวจเช็คสต๊อก</div>
					         <div class="col-2 themed-grid-col">พนักงาน PC</div><!-- 9 -->
						  </div>
							...
							for(int n=0;n<resultList.size();n++){
								...
								%>
								<div class="row mb-1">
							     <div class="col-1 themed-grid-col-detail">
							      <%if ( UserUtils.userInRole("ROLE_MC",user,new String[]{User.ADMIN, User.MC_ENTRY}) ){ %>	  
							     ...
							     <div class="col-1 themed-grid-col-detail">
							        <input type ="checkbox" name="chCheck" id="chCheck" onclick="saveSelectedInPage(<%=n%>)" class="largerCheckbox" />
									<input type ="hidden" name="code_temp" value="<%=item.getId() %>" />
							     </div>
							     <div class="col-1 themed-grid-col-detail"><%=no %></div>
						         <div class="col-1 themed-grid-col-detail"><%=item.getStockDate() %></div>
						         <div class="col-1 themed-grid-col-detail"><%=item.getCustomerCode() %></div>
						         <div class="col-2 themed-grid-col-detail"><%=item.getCustomerName()%></div>
						         <div class="col-2 themed-grid-col-detail"><%=item.getStoreName()%></div>
						         <div class="col-1 themed-grid-col-detail"><%=item.getCreateUser() %></div>
						         <div class="col-2 themed-grid-col-detail"><%=item.getMcName() %></div><!-- 9 -->
							  </div>
