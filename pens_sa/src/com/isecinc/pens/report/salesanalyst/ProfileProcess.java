...
public class ProfileProcess {
	...
	public static boolean insertProfileBlankModel(Connection conn,User u,SABean b) throws Exception{
		PreparedStatement psIns = null;
		try{
			String sqlInsert = " INSERT INTO PENSBI.C_USER_PROFILE \n"
					+" (USER_ID, PROFILE_ID, TYPE_SEARCH, DATE_FROM, DATE_TO,  \n"
	...
	public static int getMaxProfileId(Connection conn,int userId) throws Exception{
		PreparedStatement psIns = null;
		ResultSet rs = null;
		int maxProfileId = 0;
		try{
	...
	public static String getProfileName(Connection conn,int userId,int profileId) throws Exception{
		PreparedStatement psIns = null;
		ResultSet rs = null;
		String profileName = "";
		try{
			String sqlUpdate = "SELECT profile_id, profile_name from PENSBI.C_USER_PROFILE "
