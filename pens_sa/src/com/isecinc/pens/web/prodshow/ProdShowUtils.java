...
public class ProdShowUtils {
	...
	public static List<PopupBean> initPeriod(Connection conn){
		...
		try{
			...
			sql.append("select to_char(show_date,'mm/yyyy') as r \n"
					+ ", to_number(to_char(show_date,'yyyymm') ) as r2 \n"
					+ " from XXPENS_OM_PRODSHOW_MST \n"
					+ " ) order by r2 desc \n");
	...
	public static ProdShowBean getPeriodDesc(Calendar cal)throws Exception{
		ProdShowBean s = new ProdShowBean();
		String mm ="";
		String yyyy="";
		try{
