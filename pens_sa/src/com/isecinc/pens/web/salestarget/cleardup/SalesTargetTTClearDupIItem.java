...
public class SalesTargetTTClearDupIItem {
	protected static Logger logger = Logger.getLogger("PENS");
	
	public static void main(String[] a){
		try{
			
			processClearDupMKT_TT("AUG-19","1");
		}catch(Exception e){
			e.printStackTrace();
		}
	}
	...
	/** Case Dup Item TT_L **/
	public static void processClearDupMKT_TT(String period ,String zone) throws Exception {
