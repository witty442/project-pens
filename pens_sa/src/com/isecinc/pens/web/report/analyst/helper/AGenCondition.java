...
import com.isecinc.pens.web.report.analyst.process.AConstants;
import com.isecinc.pens.web.report.analyst.process.AGenerateSQL;
import com.isecinc.pens.web.report.analyst.process.AInitial;
import com.pens.util.ControlCode;
import com.pens.util.DateUtil;
import com.pens.util.Utils;

public class AGenCondition {
	
	protected static  Logger logger = Logger.getLogger("PENS");
	AUtils reportU = new AUtils();
	...
	public AGenCondition(AInitial aaInit){
		aInit = aaInit;
	}
   ...
   /** WIT Say:Wait for Case Month year difference Not work 21/06/2019 **/
	...
	public  String genSqlWhereCondition(ABean salesBean) throws Exception{
	...
	public  String genSqlWhereCondition(ABean salesBean,String aliasSub) throws Exception{
		...
		if( !"-1".equals(Utils.isNull(salesBean.getCondName1())) &&  !"-1".equals(Utils.isNull(salesBean.getCondValue1()))){
			if(Utils.isNull(salesBean.getCondName1()).equalsIgnoreCase("invoice_date")|| Utils.isNull(salesBean.getCondName1()).equalsIgnoreCase("SALES_ORDER_DATE")){
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName1()))){
					sql +="and ( ";
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName1())+" IN ("+ AUtils.converToText(salesBean.getCondName1(), Utils.isNull(salesBean.getCondValue1()))+") \n ";
					sql +="     or \n";
					// Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName1())+" IN ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no in ("+ AUtils.converToText(salesBean.getCondName1(), Utils.isNull(salesBean.getCondValue1()))+") ) \n ";
					sql +=" ) \n";
				}else{
					sql +="and ( ";
				    ...
				    sql +="     or \n";
				   // Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName1())+" = ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no = '"+ AUtils.converToText(salesBean.getCondName1(), Utils.isNull(salesBean.getCondValue1()))+"' ) \n ";
					sql +=" ) \n";
				}
			}else if(Utils.isNull(salesBean.getCondName1()).equalsIgnoreCase("SUBBRAND")){
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName1()))){
			       sql +="AND  INVENTORY_ITEM_ID IN ( select INVENTORY_ITEM_ID from XXPENS_BI_MST_SUBBRAND where subbrand_no in ("+ AUtils.converToText(salesBean.getCondName1(), Utils.isNull(salesBean.getCondValue1()))+"))\n ";
				}
			}else{
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName1()))){
					sql +="and "+aliasSub+ Utils.isNull(salesBean.getCondName1())+" IN ("+ AUtils.converToText(salesBean.getCondName1(), Utils.isNull(salesBean.getCondValue1()))+") \n ";
				}else if(AUtils.isColumnNumberType(Utils.isNull(salesBean.getCondName1()))){
		...
		if( !"-1".equals(Utils.isNull(salesBean.getCondName2())) &&  !"-1".equals(Utils.isNull(salesBean.getCondValue2()))){
			if(Utils.isNull(salesBean.getCondName2()).equalsIgnoreCase("invoice_date") || Utils.isNull(salesBean.getCondName2()).equalsIgnoreCase("SALES_ORDER_DATE")){
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName2()))){
					sql +="and ( ";
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName2())+" IN ("+ AUtils.converToText(salesBean.getCondName2(), Utils.isNull(salesBean.getCondValue2()))+") \n ";
					sql +="     or \n";
					// Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName2())+" IN ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no in ("+ AUtils.converToText(salesBean.getCondName2(), Utils.isNull(salesBean.getCondValue2()))+") ) \n ";
					sql +=" ) \n";
				}else{
					sql +="and ( ";
				    ...
				    sql +="     or \n";
				   // Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName2())+" = ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no = '"+ AUtils.converToText(salesBean.getCondName2(), Utils.isNull(salesBean.getCondValue2()))+"' ) \n ";
					sql +=" ) \n";
				}
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName2()))){
				       sql +="AND  INVENTORY_ITEM_ID IN ( select INVENTORY_ITEM_ID from XXPENS_BI_MST_SUBBRAND where subbrand_no in ("+ AUtils.converToText(salesBean.getCondName2(), Utils.isNull(salesBean.getCondValue2()))+")) \n ";
				}
			}else{
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName2()))){
					sql +="and "+aliasSub+ Utils.isNull(salesBean.getCondName2())+" IN ("+AUtils.converToText(salesBean.getCondName2(), Utils.isNull(salesBean.getCondValue2()))+") \n ";
				}
				else if(AUtils.isColumnNumberType(Utils.isNull(salesBean.getCondName2()))){
		...
		if( !"-1".equals(Utils.isNull(salesBean.getCondName3())) &&  !"-1".equals(Utils.isNull(salesBean.getCondValue3()))){
			if(Utils.isNull(salesBean.getCondName3()).equalsIgnoreCase("invoice_date") || Utils.isNull(salesBean.getCondName3()).equalsIgnoreCase("SALES_ORDER_DATE")){
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName3()))){
					sql +="and ( ";
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName3())+" IN ("+ AUtils.converToText(salesBean.getCondName3(), Utils.isNull(salesBean.getCondValue3()))+") \n ";
					sql +="     or \n";
					// Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName3())+" IN ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no in ("+ AUtils.converToText(salesBean.getCondName3(), Utils.isNull(salesBean.getCondValue3()))+") ) \n ";
					sql +=" ) \n";
				}else{
					sql +="and ( ";
				    ...
				    sql +="     or \n";
				   // Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName3())+" = ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no = '"+ AUtils.converToText(salesBean.getCondName3(), Utils.isNull(salesBean.getCondValue3()))+"' ) \n ";
					sql +=" ) \n";
				}
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName3()))){
				      sql +="AND  INVENTORY_ITEM_ID IN ( select INVENTORY_ITEM_ID from XXPENS_BI_MST_SUBBRAND where subbrand_no in ("+ AUtils.converToText(salesBean.getCondName3(), Utils.isNull(salesBean.getCondValue3()))+")) \n ";
				}
			}else{
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName3()))){
					sql +="and "+aliasSub+ Utils.isNull(salesBean.getCondName3())+" IN ("+AUtils.converToText(salesBean.getCondName3(), Utils.isNull(salesBean.getCondValue3()))+") \n ";
				}
				else if(AUtils.isColumnNumberType(Utils.isNull(salesBean.getCondName3()))){
		...
		if( !"-1".equals(Utils.isNull(salesBean.getCondName4())) &&  !"-1".equals(Utils.isNull(salesBean.getCondValue4()))){
			if(Utils.isNull(salesBean.getCondName4()).equalsIgnoreCase("invoice_date")|| Utils.isNull(salesBean.getCondName4()).equalsIgnoreCase("SALES_ORDER_DATE")){
				...
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName4()))){
					sql +="and ( ";
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName4())+" IN ("+ AUtils.converToText(salesBean.getCondName4(), Utils.isNull(salesBean.getCondValue4()))+") \n ";
					sql +="     or \n";
					// Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName4())+" IN ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no in ("+ AUtils.converToText(salesBean.getCondName4(), Utils.isNull(salesBean.getCondValue4()))+") ) \n ";
					sql +=" ) \n";
				}else{
					sql +="and ( ";
				    ...
				    sql +="     or \n";
				   // Brand group
					sql +="    "+aliasSub+ Utils.isNull(salesBean.getCondName4())+" = ( select brand_no from XXPENS_BI_MST_BRAND_GROUP where brand_group_no = '"+ AUtils.converToText(salesBean.getCondName4(), Utils.isNull(salesBean.getCondValue4()))+"' ) \n ";
					sql +=" ) \n";
				}
			}else if(Utils.isNull(salesBean.getCondName3()).equalsIgnoreCase("SUBBRAND")){
			    // sql +="AND  INVENTORY_ITEM_ID IN ( select INVENTORY_ITEM_ID from XXPENS_BI_MST_SUBBRAND where subbrand_no = '"+ Utils.isNull(salesBean.getCondValue3())+"' ) \n ";
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName4()))){
				      sql +="AND  INVENTORY_ITEM_ID IN ( select INVENTORY_ITEM_ID from XXPENS_BI_MST_SUBBRAND where subbrand_no in ("+ AUtils.converToText(salesBean.getCondName4(), Utils.isNull(salesBean.getCondValue4()))+")) \n ";
				}
			}else{
				if(aInit.MULTI_SELECTION_LIST.contains(Utils.isNull(salesBean.getCondName4()))){
					sql +="and "+ Utils.isNull(salesBean.getCondName4())+" IN ("+AUtils.converToText(salesBean.getCondName4(), Utils.isNull(salesBean.getCondValue4()))+") \n ";
				}
				else if(AUtils.isColumnNumberType(Utils.isNull(salesBean.getCondName4()))){
	...
	public StringBuffer genSqlWhereCondByGroup(ABean salesBean,String type,String alias,String colGroupName) throws Exception{
	...
	public  String genSubSQLByType(Connection conn,User user ,ABean salesBean,String type,String groupBy,String colGroupName) throws Exception{
		StringBuffer sql = new StringBuffer("");
		...
		if("ORDER".equalsIgnoreCase(type)){
			...
			sql.append("\t\t"+" '1' AS A \n");
			sql.append("\t\t"+" FROM "+aInit.TABLE_VIEW+" V \n");
			...
			if(AConstants.TYPE_SEARCH_MONTH.equalsIgnoreCase(salesBean.getTypeSearch())){
			    ...
			    sql.append(AGenCondition.genWhereCondSQLCaseByMonthYear("\t\t","","ORDER","'"+colGroupName+"'"));
			    
			}else if(AConstants.TYPE_SEARCH_QUARTER.equalsIgnoreCase(salesBean.getTypeSearch())){
				//sql.append(""+" AND sales_order_quarter = '"+colGroupName.substring(4,5)+"' \n");
				//sql.append("\t\t"+" AND sales_order_year = '"+colGroupName.substring(0,4)+"' \n");
				
				sql.append(AGenCondition.genWhereCondSQLCaseByQuarterYear("\t\t","","ORDER","'"+colGroupName+"'"));
				
			}else if(AConstants.TYPE_SEARCH_YEAR.equalsIgnoreCase(salesBean.getTypeSearch())){
				//sql.append(""+" AND sales_order_year = '"+colGroupName+"' \n");
				sql.append("\t"+AGenCondition.genWhereCondSQLCaseByYEAR("ORDER",colGroupName));
			}else{
				Date date = DateUtil.parseToBudishDate(!StringUtils.isEmpty(salesBean.getDay())?salesBean.getDay():salesBean.getDayTo() , DateUtil.DD_MM_YYYY_WITH_SLASH);
			...
			if(AConstants.TYPE_SEARCH_MONTH.equalsIgnoreCase(salesBean.getTypeSearch())){
			   ...
			   // sql.append("\t\t"+" AND invoice_year = '"+colGroupName.substring(0,4)+"' \n");
				 ...
				 sql.append(AGenCondition.genWhereCondSQLCaseByMonthYear("\t\t","","INVOICE","'"+colGroupName+"'"));
			}else if(AConstants.TYPE_SEARCH_QUARTER.equalsIgnoreCase(salesBean.getTypeSearch())){
				//sql.append(""+" AND invoice_quarter = '"+colGroupName.substring(4,5)+"' \n");
				//sql.append("\t\t"+" AND invoice_year = '"+colGroupName.substring(0,4)+"' \n");
				
				 sql.append(AGenCondition.genWhereCondSQLCaseByQuarterYear("\t\t","","INVOICE","'"+colGroupName+"'"));
				 
			}else if(AConstants.TYPE_SEARCH_YEAR.equalsIgnoreCase(salesBean.getTypeSearch())){
				//sql.append(""+" AND invoice_year = '"+colGroupName+"' \n");
				sql.append("\t"+AGenCondition.genWhereCondSQLCaseByYEAR("INVOICE",colGroupName));
			}else{
				Date date = DateUtil.parseToBudishDate(!StringUtils.isEmpty(salesBean.getDay())?salesBean.getDay():salesBean.getDayTo(), DateUtil.DD_MM_YYYY_WITH_SLASH);
	 ...
	 */
	public  StringBuffer genSqlCountCustomerNoDup(ABean salesBean,String groupBy,String colGroupName,String sqlNotInCaseCall) throws Exception{
		StringBuffer ss = new StringBuffer("");
		
		ss.append("\n NVL( ");
		ss.append("\n  ( SELECT COUNT(DISTINCT c.c_id) as c_id FROM( ");
		ss.append("\n \t  SELECT DISTINCT c.customer_id as c_id ,c."+groupBy+" from "+aInit.TABLE_VIEW+" c " );
		ss.append("\n \t      WHERE 1=1 " );
	...
	public  StringBuffer genSqlCountCustomer(ABean salesBean,String groupBy,String colGroupName) throws Exception{
		StringBuffer ss = new StringBuffer("");
	...
	public  StringBuffer genSqlMinusCustomerId(ABean salesBean,List<StringBuffer> sqlNotInCaseCallAllList) throws Exception{
		StringBuffer ss = new StringBuffer("");
		...
		for(int i=0;i<sqlNotInCaseCallAllList.size();i++){
			...
			ss.append("\n      UNION ALL ");
			ss.append("\n      SELECT distinct c.customer_id as c_id ,c."+salesBean.getGroupBy()+" from "+aInit.TABLE_VIEW+" c " );
			ss.append("\n      WHERE 1=1 " );
			ss.append("\n      "+condNotInAll );
	...
	public  String[] genTopSQLSelectColumn(ABean salesBean,String groupBy,String colGroupName) throws Exception{
	 ...
	 * 
	 */
	public  String[] genTopSQLSelectColumn(ABean salesBean,String groupBy,String colGroupName,String sqlNotIncaseCall) throws Exception{
		...
		//EDIT 24/04/2563
		columnAll.append(AGenerateSQL.genSQLNA(groupBy) +", ");
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp1()))){
			...
			if("CALL_NEW".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp1()))){
				...
				String columnNameNoDup = AConstants.NO_DUP_PREFIX+salesBean.getColNameDisp1()+"_"+salesBean.getColNameUnit1()+"_1_"+colGroupName;
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp2()))){
			...
			if("CALL_NEW".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp2()))){
				...
				String subSelectNoDup = genSqlCountCustomerNoDup(salesBean, groupBy, colGroupName,sqlNotIncaseCall).toString();
				String columnNameNoDup = AConstants.NO_DUP_PREFIX+salesBean.getColNameDisp2()+"_"+salesBean.getColNameUnit2()+"_2_"+colGroupName;
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp3()))){
			...
			if("CALL_NEW".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp3()))){
				...
				String subSelectNoDup = genSqlCountCustomerNoDup(salesBean, groupBy, colGroupName,sqlNotIncaseCall).toString();
			    String columnNameNoDup = AConstants.NO_DUP_PREFIX+salesBean.getColNameDisp3()+"_"+salesBean.getColNameUnit3()+"_3_"+colGroupName;
       ...
       if( !"0".equals(Utils.isNull(salesBean.getColNameDisp4()))){
			...
			if("CALL_NEW".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp4()))){
				...
				String columnNameNoDup = AConstants.NO_DUP_PREFIX+salesBean.getColNameDisp4()+"_"+salesBean.getColNameUnit4()+"_4_"+colGroupName;
	 ...
	 * @throws Exception
	 */
	public  String genSQLSelectColumn(ABean salesBean,String type ,String groupBy,String colGroupName) throws Exception{
		String sql ="";
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp1()))){
			if( !"CALL".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp1())) && 
				!"CALL_NEW".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp1()))
				  ...
				  if("ORDER".equalsIgnoreCase(type) && aInit.COLUMN_ORDER_MAP.get(salesBean.getColNameDisp1()) != null){
				     sql +=colName1 +" as "+colAlias1+",  ";
				  }else if("INVOICE".equalsIgnoreCase(type) && aInit.COLUMN_INVOICE_MAP.get(salesBean.getColNameDisp1()) != null){
				     sql +=colName1 +" as "+colAlias1+",  ";
				  }else{
				   sql +=" 0 as "+colAlias1+", ";
				  }
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp2()))){
	        if( !"CALL".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp2())) && 
				...
				if("ORDER".equalsIgnoreCase(type) && aInit.COLUMN_ORDER_MAP.get(salesBean.getColNameDisp2()) != null){
				   sql +=colName2 +" as "+colAlias2+",  ";
				}else if("INVOICE".equalsIgnoreCase(type) && aInit.COLUMN_INVOICE_MAP.get(salesBean.getColNameDisp2()) != null){
				   sql +=colName2 +" as "+colAlias2+",  ";
				}else{
				   sql +=" 0 as "+colAlias2+",  ";
				}
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp3()))){
	        if( !"CALL".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp3())) && 
				...
				if("ORDER".equalsIgnoreCase(type) && aInit.COLUMN_ORDER_MAP.get(salesBean.getColNameDisp3()) != null){
				   sql +=colName3 +" as "+colAlias3+",  ";
				}else if("INVOICE".equalsIgnoreCase(type) && aInit.COLUMN_INVOICE_MAP.get(salesBean.getColNameDisp3()) != null){
				   sql +=colName3 +" as "+colAlias3+",  ";
				}else{
				   sql +=" 0 as "+colAlias3+",  ";
				}
		...
		if( !"0".equals(Utils.isNull(salesBean.getColNameDisp4()))){
	        if( !"CALL".equalsIgnoreCase(Utils.isNull(salesBean.getColNameDisp4())) &&
				...
				if("ORDER".equalsIgnoreCase(type) && aInit.COLUMN_ORDER_MAP.get(salesBean.getColNameDisp4()) != null){
				   sql +=colName4 +" as "+colAlias4+",  ";
				}else if("INVOICE".equalsIgnoreCase(type) && aInit.COLUMN_INVOICE_MAP.get(salesBean.getColNameDisp4()) != null){
				   sql +=colName4 +" as "+colAlias4+",  ";
				}else{
				   sql +=" 0 as "+colAlias4+",  ";
				}
