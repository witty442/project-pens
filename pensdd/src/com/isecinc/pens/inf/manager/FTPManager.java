 ...
 */
	 ...
	 * ExportManager Call
	 */
	public void exportAllFileToFTP(LinkedHashMap<String,TableBean> controlTableMap,String path) throws Exception{
		FTPClient ftp = null;
		try {		
			ftp = new FTPClient();
	 ...
	 * @throws Exception
	 */
	public void exportBackUpDBFileToFTP(User user,String parentPath,String fileName,StringBuffer dataFiles) throws Exception{
		FTPClient ftp = null;
		File file = null;
		FileInputStream fis = null;
		try {		
	...
	public void exportBackUpDBZipFileToFTP(User user,String parentPath,String fileName,String localFile) throws Exception{
		FTPClient ftp = null;
		File file = null;
		FileInputStream fis = null;
...
//            }
            ...
            logger.debug("store xx " +parentPath+userTypePath+fileName + " complete");
			/******************************************************************/
