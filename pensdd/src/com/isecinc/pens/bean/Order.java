...
public class Order extends I_PO implements Serializable {
	...
	public Order(ResultSet rst) throws Exception {
		...
		setOraBillAddressID(rst.getInt("ORA_SHIP_ADDRESS_ID"));
	...
	private double totalNeedBill ;

	public double getTotalNeedBill() {
		return totalNeedBill;
	}

	public void setTotalNeedBill(double totalNeedBill) {
		this.totalNeedBill = totalNeedBill;
	}
}
