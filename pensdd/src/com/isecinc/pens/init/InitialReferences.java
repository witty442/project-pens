...
public class InitialReferences extends I_Initial {
	...
	public static final String PERIODS_LIST = "Periods";
	public static final String MAX_QTY_BENICAL = "MaxQtyBenical";
	...
	public void init(Connection conn) {
		try {
			...
			/*MTaxInvoice tax = new MTaxInvoice();
			referenes.put(PERIODS_LIST,tax.getTaxPeriods(conn));*/
