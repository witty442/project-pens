...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" id="bannerHeader">
	<tr>
		...
		<td align="right" valign="top">
			<div>
				<span class="userlabel"><%=((User)session.getAttribute("user")).getCode() %>:<%=((User)session.getAttribute("user")).getName() %>/<%=((User)session.getAttribute("user")).getRole().getName() %></span>&nbsp;&nbsp;
				<br>
