	      		...
	      		<tr>
					...
					<table align="center" border="0" cellpadding="3" cellspacing="1" class="result">
						<tr>
							...
							<th class="name"><bean:message key="Customer.Code" bundle="sysele"/></th>
							<th class="name"><bean:message key="Customer.Name" bundle="sysele"/></th>
							<th class="name"><bean:message key="Customer.SubName" bundle="sysele"/></th>
					...
					<c:forEach var="results" items="${customerForm.results}" varStatus="rows">
						...
						<tr class="<c:out value='${tabclass}'/>">
							...
							<td align="left" width="117px;">${results.code}</td>
							<td align="left" width="99px;">${results.name}</td>
							<td align="left" width="97px;">${results.name2}</td>
							<td align="right" width="59px;">
								<fmt:formatNumber pattern="#,##0.00" value="${results.creditLimit}"/>
							</td>
							<td align="right" width="58px;">
							...
							<%} %>
							<td align="center" width="50px;">${results.activeLabel}</td>
							<!-- OLD CODE************** -->
<!--							<%//if(role.equalsIgnoreCase(User.VAN)){ %>-->
