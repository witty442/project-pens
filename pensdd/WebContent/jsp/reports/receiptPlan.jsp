...
<jsp:useBean id="receiptPlanForm" class="com.isecinc.pens.web.report.receiptplan.ReceiptPlanReportForm" scope="request" />
<%
...
function gotoReport(path){
	...
	document.receiptPlanReportForm.action = path + "/jsp/receiptPlanReport.do?do=searchReport&rf=Y";
	document.receiptPlanReportForm.submit();
	return true;
}

function clearForm(path){
	document.receiptPlanReportForm.action = path + "/jsp/receiptPlanReport.do?do=clearForm";
	document.receiptPlanReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ReceiptPlanReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/receiptPlanReport">
						...
						<table style="text-align:center" align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td width="40%" align="right">วันที่รับชำระ  ตั้งแต่ :&nbsp;</td>
								<td align="left">
								<html:text property="receiptPlanReport.dateFrom" styleId="dateFrom" readonly="true" size="15" /><font color="red">*</font>
								&nbsp;&nbsp;&nbsp;&nbsp;
								     ถึง :&nbsp;<html:text property="receiptPlanReport.dateTo" styleId="dateTo" readonly="true" size="15"/><font color="red">*</font>
								     <br/>
								</td>
							</tr>
							<tr>
								...
								<td align="left">
									<html:select property="receiptPlanReport.param_PaymentMethod" styleId="paymentMethod">
