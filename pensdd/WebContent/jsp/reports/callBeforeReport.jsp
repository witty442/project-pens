...
<jsp:useBean id="callBeforeReportForm" class="com.isecinc.pens.web.report.callbefore.CallBeforeReportForm" scope="request" />
<%
...
function gotoReport(path){
	...
	document.callBeforeReportForm.action = path + "/jsp/callBeforeReportAction.do?do=searchReport&rf=Y";
	document.callBeforeReportForm.submit();
	return true;
}

function clearForm(path){
	document.callBeforeReportForm.action = path + "/jsp/callBeforeReportAction.do?do=clearForm";
	document.callBeforeReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="CallBeforeSendReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/callBeforeReportAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								     <html:text property="callBeforeReport.shippingDate" styleId="shippingDate" readonly="true" size="15"/>
								</td>
							</tr>
							<tr>
