...
<%@page import="com.isecinc.pens.model.MTaxInvoice"%>
<jsp:useBean id="salesVATForm" class="com.isecinc.pens.web.report.vat.SalesVATReportAction" scope="request" />
<%
List<References> periods = new MTaxInvoice().getTaxPeriods();
...
function loadMe(){
	...
	document.getElementById("isShowCancel").checked = true;
}

function gotoReport(path){
	if($('#period').val()==''){
		alert('กรุณากำหนด เดือนภาษี');
		$('#period').focus();
		return;
	}
	...
	document.salesVATReportForm.action = path + "/jsp/salesVATReport.do?do=searchReport&rf=Y";
	document.salesVATReportForm.submit();
	return true;
}

function clearForm(path){
	document.salesVATReportForm.action = path + "/jsp/salesVATReport.do?do=clearForm";
	document.salesVATReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="SalesVATReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/salesVATReport">
						...
						<table style="text-align:center" align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td width="40%" align="right">เดือนภาษี :&nbsp;</td>
								<td align="left">
									<html:select property="salesVATReport.period" styleId="period">
										<html:option value="">กรุณากำหนดข้อมูล</html:option>
										<html:options collection="periods" property="key" labelProperty="name" />
									</html:select>
									<font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td width="40%" align="right">แสดงข้อมูลยกเลิก :&nbsp;</td>
								<td align="left">
										<html:checkbox property="salesVATReport.isShowCancel" styleId="isShowCancel" value="Y" />
								</td>
							</tr>
							<tr>
