...
<jsp:useBean id="formReceipt" class="com.isecinc.pens.web.report.receipt.FormReceiptForm" scope="request" />
...
function gotoReport(path){
	...
	document.formReceiptForm.action = path + "/jsp/formReceiptAction.do?do=searchReport&rf=Y";
	document.formReceiptForm.submit();
	return true;
}

function clearForm(path){
	document.formReceiptForm.action = path + "/jsp/formReceiptAction.do?do=clearForm";
	document.formReceiptForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="FormReceipt"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/formReceiptAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								<html:text property="receiptForm.receiptDateFrom" styleId="receiptDateFrom" readonly="true" size="15"/> - 
								<html:text property="receiptForm.receiptDateTo" styleId="receiptDateTo" readonly="true" size="15"/> 
								</td>
							</tr>
							<tr>
								<td align="right"><bean:message key="Customer.Code" bundle="sysele"/></td>
								<td align="left">
								<html:text property="receiptForm.customerCode" styleId="customerCode" size="15"/>
								</td>
							</tr>
							<tr>
