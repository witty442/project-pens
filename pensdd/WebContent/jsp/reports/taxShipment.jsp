...
<jsp:useBean id="taxShipmentForm" class="com.isecinc.pens.web.report.shipment.TaxShipmentForm" scope="request" />
...
function loadMe(){
	new Epoch('epoch_popup','th',document.getElementById('taxinvoiceDateTo'));
	new Epoch('epoch_popup','th',document.getElementById('taxinvoiceDateFrom'));
}

function gotoReport(path){
	if($('#taxinvoiceDateTo').val()==''){
		alert('กรุณาใส่เงื่อนไขในการออกรายงาน');
		$('#taxinvoiceDateTo').focus();
		return;
	}
	if($('#taxinvoiceDateFrom').val()==''){
		alert('กรุณาใส่เงื่อนไขในการออกรายงาน');
		$('#taxinvoiceDateFrom').focus();
		return;
	}
	...
	document.taxShipmentForm.action = path + "/jsp/taxShipmentAction.do?do=searchReport&rf=Y";
	document.taxShipmentForm.submit();
	return true;
}

function clearForm(path){
	document.taxShipmentForm.action = path + "/jsp/taxShipmentAction.do?do=clearForm";
	document.taxShipmentForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="TaxShipment"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/taxShipmentAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								<html:text property="taxShipment.taxinvoiceDateFrom" styleId="taxinvoiceDateFrom" readonly="true" size="15"/> - 
								<html:text property="taxShipment.taxinvoiceDateTo" styleId="taxinvoiceDateTo" readonly="true" size="15"/> 
								</td>
							</tr>
							<tr>
								<td align="right"><bean:message key="Customer.Code" bundle="sysele"/></td>
								<td align="left">
								<html:text property="taxShipment.customerCode" styleId="customerCode" size="15"/>
								</td>
							</tr>
							<tr>
