...
<jsp:useBean id="shipmentDetailReportForm" class="com.isecinc.pens.web.report.shipment.ShipmentDetailReportForm" scope="request" />
<%
...
function gotoReport(path){
	...
	document.shipmentDetailReportForm.action = path + "/jsp/shipmentDetailReport.do?do=searchReport&rf=Y";
	document.shipmentDetailReportForm.submit();
	return true;
}

function clearForm(path){
	document.shipmentDetailReportForm.action = path + "/jsp/shipmentDetailReport.do?do=clearForm";
	document.shipmentDetailReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ShipmentDetailReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/shipmentDetailReport">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								     <html:text property="shipmentReport.shipmentDate" styleId="shipmentDate" readonly="true" size="15"/>
								</td>
							</tr>
							<tr>
