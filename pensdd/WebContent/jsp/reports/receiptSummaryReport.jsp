...
<jsp:useBean id="receiptSumRptForm" class="com.isecinc.pens.web.report.receiptsummary.ReceiptSummaryReportAction" scope="request" />
<%
...
function gotoReport(path){
	...
	document.receiptSummaryReportForm.action = path + "/jsp/receiptSummaryReport.do?do=searchReport&rf=Y";
	document.receiptSummaryReportForm.submit();
	return true;
}

function clearForm(path){
	document.receiptSummaryReportForm.action = path + "/jsp/receiptSummaryReport.do?do=clearForm";
	document.receiptSummaryReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ReceiptSummaryReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/receiptSummaryReport">
						...
						<table style="text-align:center" align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td width="40%" align="right">วันที่รับเงินตั้งแต่ :&nbsp;</td>
								<td align="left">
									<html:text property="receiptSummaryReport.receiptDateFrom" styleId="receiptDateFrom" readonly="true" size="15" /><font color="red">*</font>
								&nbsp;&nbsp;&nbsp;&nbsp;
								     ถึง :&nbsp;<html:text property="receiptSummaryReport.receiptDateTo" styleId="receiptDateTo" readonly="true" size="15"/><font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td width="40%" align="right">ประเภทการรับชำระ :&nbsp;</td>
								<td align="left">
										<html:select property="receiptSummaryReport.paymentMethod" styleId="paymentMethod">
