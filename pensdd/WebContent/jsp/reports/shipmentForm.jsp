...
<jsp:useBean id="shipmentFormForm" class="com.isecinc.pens.web.report.shipment.ShipmentFormForm" scope="request" />
...
function loadMe(){
	new Epoch('epoch_popup','th',document.getElementById('shipmentDateTo'));
	new Epoch('epoch_popup','th',document.getElementById('shipmentDateFrom'));
}

function gotoReport(path){
	if($('#shipmentDateTo').val()==''){
		alert('กรุณาใส่เงื่อนไขในการออกรายงาน');
		$('#shipmentDateTo').focus();
		return;
	}
	if($('#shipmentDateFrom').val()==''){
		alert('กรุณาใส่เงื่อนไขในการออกรายงาน');
		$('#shipmentDateFrom').focus();
		return;
	}
	...
	document.shipmentFormForm.action = path + "/jsp/shipmentFormAction.do?do=searchReport&rf=Y";
	document.shipmentFormForm.submit();
	return true;
}

function clearForm(path){
	document.shipmentFormForm.action = path + "/jsp/shipmentFormAction.do?do=clearForm";
	document.shipmentFormForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ShipmentForm"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/shipmentFormAction">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
								<html:text property="formShipment.shipmentDateFrom" styleId="shipmentDateFrom" readonly="true" size="15"/> - 
								<html:text property="formShipment.shipmentDateTo" styleId="shipmentDateTo" readonly="true" size="15"/> 
								</td>
							</tr>
							<tr>
								<td align="right"><bean:message key="Customer.Code" bundle="sysele"/></td>
								<td align="left">
								<html:text property="formShipment.customerCode" styleId="customerCode" size="15"/>
								</td>
							</tr>
							<tr>
