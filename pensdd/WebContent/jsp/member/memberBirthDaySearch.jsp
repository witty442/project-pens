...
function search(path){
	$(function(){
		var getData = $.ajax({
			url: path + "/jsp/ajax/memberBirthDayQuery.jsp",
			data : "dateFrom=" + $('#dateFrom').val()
			+ "&dateTo=" + $('#dateTo').val(),
			async: false,
			success: function(getData){
				var returnString = getData;
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="Member.BirthDay"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right" width="30%"><bean:message key="DateFrom" bundle="sysele"/>&nbsp;&nbsp;</td>
								<td align="left" width="10%">
									<input type="text" id="dateFrom" name="dateFrom" size="15" readonly="readonly">
								</td>
								<td align="right" width="10%"><bean:message key="To" bundle="sysele"/>&nbsp;&nbsp;</td>
								<td align="left">
									<input type="text" id="dateTo" name="dateTo" size="15" readonly="readonly">
								</td>
							</tr>
						</table>
						<br><br>
