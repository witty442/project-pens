...
function loadMe(){
	...
	paymentMethodChanged(document.getElementById("paymentMethod"),'N');
}
//call ajax
...
function paymentMethodChanged(paymentMethod,clearValue){
	//alert(paymentMethod.value);
	var creditCardNo = $('#creditCardNo');
	//alert("creditCardNo "+creditCardNo.value);
	var creditCardBank = $('#creditCardBank');
	//alert("creditCardBank "+creditCardBank.value);
	var creditCardExpiredDate = $('#creditcardExpired');
	//alert("creditCardExpiredDate "+creditCardExpiredDate.value);
	
	if('CR' ==paymentMethod.value){
		creditCardNo.attr("readonly","");
		creditCardNo.attr("class","");
		creditCardBank.attr("disabled","");
		creditCardBank.attr("class","");
		creditCardExpiredDate.attr("readonly","");
		creditCardExpiredDate.attr("class","");
	}
	else{
		if('Y'==clearValue){
			creditCardNo.val('');
			creditCardBank.val(['']);
			creditCardExpiredDate.val('');
		}
		creditCardNo.attr("readonly","readonly");
		creditCardNo.attr("class","disableText");
		creditCardBank.attr("disabled","disabled");
		creditCardBank.attr("class","disableText");
		creditCardExpiredDate.attr("readonly","readonly");
		creditCardExpiredDate.attr("class","disableText");
	}
}
</script>
</head>
						...
						<jsp:include page="../error.jsp"/>
							<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td align="left"><html:text property="member.age" size="10" style="text-align: right;" onclick="calculateAge(document.getElementById('birthDay'), this);" readonly="true"/></td>
								</tr>
								<tr>
									...
									<td align="left"><html:text property="member.monthlyIncome" styleId="monthlyIncome" size="10" style="text-align: right;" onkeydown="isNum0to9andpoint(this, event);"/></td>
								</tr>
								<tr>
									<td colspan="2"></td>
									<td colspan="4"><hr></td>
								...
								<tr>
									...
									<td align="left">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;  <html:checkbox property="member.oldPriceFlag" value="Y"/>&nbsp;ราคาเดิม
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="left">
										<html:select property="member.paymentMethod" styleId="paymentMethod" onchange="paymentMethodChanged(this,'Y');">
									...
									<td align="left">
										<html:select property="member.creditCardBank" styleId="creditCardBank">
											<html:option value=""></html:option>
								...
								<tr>
									...
									<td align="left">
										<html:text property="member.creditCardNo" styleId="creditCardNo" maxlength="20" size="20" />
									</td>
									<td align="right"><bean:message key="CreditCard.ExpiredDate" bundle="sysele" />&nbsp;&nbsp;</td>
									<td align="left">
										<html:text property="member.creditcardExpired" styleId="creditcardExpired" maxlength="6" size="6" />
									</td>
								</tr>
								<tr>
									<td align="right" colspan="2"><bean:message key="CreditCard.Name" bundle="sysele" />&nbsp;&nbsp;</td>
									<td align="left" colspan="3">
										<html:text property="member.cardName" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="left">
										<html:text property="member.shippingTime" size="5" maxlength="5" onkeypress="inputTime(event, this);" onkeyup="inputTime(event, this);"/>
										<bean:message key="Member.shippingTimeTo" bundle="sysele" />
										<html:text property="member.shippingTimeTo" size="5" maxlength="5" onkeypress="inputTime(event, this);" onkeyup="inputTime(event, this);"/>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td align="left">
										<html:select property="member.paymentType" styleId="paymentType">
							...
							<input type="hidden" name="ids_address">
							<input type="hidden" name="ids_contact">
