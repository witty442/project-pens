    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="ReceiptGeneration" />
	      	...
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<c:if test="${receiptAllForm.summary.receiptSize > 0}">
							<table align="center" border="0" cellpadding="3" cellspacing="1" class="result">
							<tr>
								<th colspan="5" class="confirm">จำนวนใบเสร็จทั้งหมด  ${receiptAllForm.summary.receiptSize} รายการ</th>
							</tr>
							<tr>
							...
							<c:forEach var="results" items="${receiptAllForm.summary.successReceiptList}" varStatus="rows">
								<c:choose>
								...
								<tr class="<c:out value='${tabclass}'/>">
									...
									<td align="center">บันทึกรับเงินเรียบร้อย</td>
								</tr>
							</c:forEach>
							</table>
						</c:if>
						<c:if test="${receiptAllForm.summary.orderSize > 0}">
							<table align="center" border="0" cellpadding="3" cellspacing="1" class="result" style="border-top:10px;">
							<tr>
								<th colspan="4" class="confirm">จำนวนรายการที่ไม่สำสามารถออก ใบเสร็จได้ทั้งหมด  ${receiptAllForm.summary.orderSize} รายการ</th>
							</tr>
							<tr>
								<th><bean:message key="No" bundle="sysprop"/></th>
							...
							<% int idx = 0 ; %>
							<c:forEach var="results2" items="${receiptAllForm.summary.failOrderList}" varStatus="rows">
								<c:choose>
									<c:when test="${rows.index %2 == 0}">
										<c:set var="tabclass" value="lineO" />
									</c:when>
								...
								<% 
								String errorMsg = receiptAllForm.getSummary().getErrorMessage(idx);
								idx++;
								%>
								<tr class="<c:out value='${tabclass}'/>">
									<td><c:out value='${rows.index+1}' /></td>
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							<tr>
								<td align="right"><a href="#" onclick="clearForm('${pageContext.request.contextPath}')">
