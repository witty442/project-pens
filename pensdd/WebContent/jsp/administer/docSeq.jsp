...
<script language = "javascript" src = "${pageContext.request.contextPath}/js/docseq.js"></script>
<script language = "javascript" src = "${pageContext.request.contextPath}/js/input.js"></script>
</head>
