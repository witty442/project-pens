	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right">sss<bean:message key="Sales" bundle="sysele"/><font color="red">*</font></td>
								<td align="left">aaaa
								    <html:text property="trip.user.code" styleId="uCode" onkeypress="loadSales(event)" size="15"/>&nbsp;
