		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							<tr>
								...
								<td width="20%" align="right">ร้านค้าหลัก</td>
								<td width="25%" align="left">
								   <html:text property="order.customerName" styleId="order.customerName" size="40" readonly="true" styleClass="disableText"/> 
							...
							<tr>
								...
								<td align="left" colspan="3">
									<html:text property="order.customerBillName" size="40" 
							...
							<tr>
								...
								<td align="left" colspan="2">
									<html:text property="order.idNo" size="20" styleClass="\" autoComplete=\"off"  tabindex="3"/>
									&nbsp;&nbsp;&nbsp;&nbsp;
									Passport No &nbsp;
									<html:text property="order.passportNo" size="20" 
									styleClass="normalText"  tabindex="4"/>
								    &nbsp;&nbsp;&nbsp;&nbsp;  
							</td>
							<td align="left">   
								         อัตราภาษี &nbsp;
							...
							<tr>
								...
								<table id="tblProduct" align="left" border="0" cellpadding="3" cellspacing="1" class="result">
									<tr>
							...
							<tr>
							   <td valign="top"></td>
								<td valign="top">
								    ...
								    <tr>
								      <td align="center"><b>แสกนบาร์โค๊ด</b></td>
