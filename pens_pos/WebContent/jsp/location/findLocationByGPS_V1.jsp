...
TABLE.result TD {
  ...
  <body>
    ...
    <script>
      ...
      <%if("new".equalsIgnoreCase(runNew)){%>
          ...
          var width= window.innerWidth-100;
  	      var height= 150;
          PopupCenter('http://localhost:8080${pageContext.request.contextPath}'+"/jsp/location/popupFindLocationByGPS.jsp?", "Get Location by GPS Device",width,height);
      <%}%>
      ...
      /** Set data from child and refresh **/
      function setLocationData(lat,lng){
    	  ...
    	  document.getElementById("lat").value = lat;
     	  ...
     	  //submit
     	 window.location = "${pageContext.request.contextPath}/jsp/location/findLocationByGPS.jsp?action=foundGPS&lat="+lat+"&lng="+lng;
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=<%=GoogleMapJavaScriptAPI.getInstance().getAPIKey() %>&callback=initMap&region=TH&language=th"></script>
    ...
    <form name="locationForm"  enctype="multipart/form-data">
	    ...
	    <div id="div" align="center">
			...
			<tr>
				<th>
				    <input type="button" value="ค้นหาตำแหน่ง (GPS Device)" onclick="findMapByGPS()" class="newPosBtnLong"/>
				    <input type="button" value="ค้นหาตำแหน่ง (Google Map)" onclick="initMapModel()" class="newPosBtnLong"/>
