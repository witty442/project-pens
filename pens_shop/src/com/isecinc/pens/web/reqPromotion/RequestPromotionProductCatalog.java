...
public class RequestPromotionProductCatalog implements Comparable{
	...
	public int compareTo(Object o) {
		if (!(o instanceof RequestPromotionProductCatalog))
		      throw new ClassCastException();

		RequestPromotionProductCatalog catalog = (RequestPromotionProductCatalog) o;
