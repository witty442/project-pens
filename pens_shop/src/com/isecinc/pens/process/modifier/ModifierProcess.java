...
public class ModifierProcess {
	...
	public void findModifier(List<OrderLine> orderLines, User user, Connection conn) throws Exception {
		...
		try {
			...
			for (ProductCategory item : itemCats) {
				...
				// ALL ITEM  MODIFIER
				if(isDebug){
				  logger.info("***** Start ALL Item  LINE Group.. *********");
				}
	...
	private void processModifierLINEGROUP_AllItem(ResultSet rst, List<OrderLine> orderLines, String attr) throws Exception {
