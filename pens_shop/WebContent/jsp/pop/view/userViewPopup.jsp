...
function searchUser(e){
	if(e == null || (e != null && e.keyCode == 13)){
		$(function(){
			var getData = $.ajax({
				url: "${pageContext.request.contextPath}/jsp/ajax/view/userViewQuery.jsp",
				data : "uName=" + encodeURIComponent($('#uName').val()),
...
function selectUser(code, name){
	window.opener.setSales(code, name);
	window.close();
}
</script>
</head>
...
<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
	...
	<tr>
		<td align="right"><bean:message key="Sales.Name" bundle="sysele"/>&nbsp;&nbsp;</td>
		<td align="left" width="30%">
			<input type="text" id="uName" name="uName" size="15" onkeypress="searchUser(event)"/>
		</td>
		<td align="left">
			<input type="button" value="Search" onclick="searchUser(null);"/>
		</td>
	</tr>
	<tr>
		<td colspan="3">
