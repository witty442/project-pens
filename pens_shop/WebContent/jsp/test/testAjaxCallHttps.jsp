...
function getJsonData(){
	...
	$.ajax({
	    ...
	    headers: {"Access-Control-Allow-Headers": "GET,PUT,POST,DELETE,PATCH,OPTIONS"},
	    crossDomain: true,
	    cache: false,
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table  border="0" cellpadding="3" cellspacing="0" >
							<tr>
								<td ><div id="target">ddddd</div>
								</td>
							</tr>
							<tr>
								<td align="left"> 	
								   <input type="button" name="test" value="testGetAjax" onclick="getJsonData()"/>
								   <input type="button" name="test2" value="testPostAjax" onclick="postJsonData()"/>
								</td>
							</tr>
						</table>
					<!-- hidden field -->
