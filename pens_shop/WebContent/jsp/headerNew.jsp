...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr height="45px;" >
		<td width="27px;" valign="bottom">
		  <img src="${pageContext.request.contextPath}/images2/header_left.png" border="0" height="30px" width="30px"/>
		</td>
        ...
        <td width="31px;" valign="bottom">
          <img src="${pageContext.request.contextPath}/images2/header_right.png" border="0"  height="30px" width="30px"/>
        </td>
	</tr>
</table>
