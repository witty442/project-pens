...
<jsp:useBean id="invoicePaymentAllReportForm" class="com.isecinc.pens.web.report.invoicepayment_all.InvoicePaymentAllReportForm" scope="request" />
<%
if( Utils.isNull(invoicePaymentAllReportForm.getInvoicePaymentAllReport().getReceiptDate()).equals("")){
	invoicePaymentAllReportForm.getInvoicePaymentAllReport().setReceiptDate(Utils.stringValue(new Date(), Utils.DD_MM_YYYY_WITH_SLASH,Utils.local_th));
}
%>
...
function gotoReport(path){
	...
	document.invoicePaymentAllReportForm.action = path + "/jsp/invoicePaymentAllReportAction.do?do=searchReport&rf=Y";
	document.invoicePaymentAllReportForm.submit();
	return true;
}

function clearForm(path){
	document.invoicePaymentAllReportForm.action = path + "/jsp/invoicePaymentAllReportAction.do?do=clearForm";
	document.invoicePaymentAllReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="InvoicePaymentAllReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/invoicePaymentAllReportAction">
