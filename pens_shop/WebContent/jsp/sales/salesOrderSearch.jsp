    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="SalesOrderSearch" />
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<%-- <tr>
								<td align="right">ร้านค้าหลัก&nbsp;&nbsp; 
								</td>
								<td colspan="3">
								   <html:text property="order.customerName" size="65" readonly="true" styleClass="disableText" /> 
								   
								 </td>
							</tr> --%>
							<tr>
								<td align="center" colspan="3"><b>ข้อมูลลูกค้าสำหรับออกบิล</b></td><td></td>
							</tr>
							<tr>
