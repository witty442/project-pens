...
public class StockReturnProductCatalog implements Comparable{
	...
	public int compareTo(Object o) {
		if (!(o instanceof StockReturnProductCatalog))
		      throw new ClassCastException();

		StockReturnProductCatalog catalog = (StockReturnProductCatalog) o;
