...
public class ImportTransTaskAction {
	...
	public  ScheduleVO  execute(Connection conn ,ScheduleVO param) {
		try{
			...
			MonitorBean monitor = new ImportTransManager().process(param.getUser());
