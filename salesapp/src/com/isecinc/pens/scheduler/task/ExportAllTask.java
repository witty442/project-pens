...
import com.isecinc.pens.scheduler.taskaction.ExportAllTaskAction;
import com.isecinc.pens.scheduler.taskaction.ExportReceiptTaskAction;
import com.isecinc.pens.scheduler.taskaction.ImportMasterTaskAction;
import com.isecinc.pens.scheduler.taskaction.ImportReceiptTaskAction;
import com.pens.util.DBConnection;

public class ExportAllTask implements org.quartz.Job{
	...
	protected static Logger logger = Logger.getLogger("PENS");
	 ...
	 public void execute(JobExecutionContext jobExecutionContext) {
		 ...
		 try{
		    ...
		    logger.debug("ImportMasterTask"+":Process Task ...AT:"+new Date());
		    
		    /******** Action************/
		    ExportAllTaskAction action = new ExportAllTaskAction();
