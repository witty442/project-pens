...
import com.isecinc.pens.scheduler.taskaction.ImportTransTaskAction;
import com.pens.util.DBConnection;

public class ImportTransTask implements org.quartz.Job{
	...
	protected static Logger logger = Logger.getLogger("PENS");
	 ...
	 public void execute(JobExecutionContext jobExecutionContext) {
		 ...
		 try{
		    ...
		    logger.debug("ImportTransTask"+":Process Task ...AT:"+new Date());
		    
		    /******** Action************/
		    ImportTransTaskAction action = new ImportTransTaskAction();
