...
import com.isecinc.pens.scheduler.taskaction.ImportInvoiceTaskAction;
import com.isecinc.pens.scheduler.taskaction.ImportReceiptTaskAction;
import com.pens.util.DBConnection;

public class ImportInvoiceTask implements org.quartz.Job{
	...
	protected static Logger logger = Logger.getLogger("PENS");
	 ...
	 public void execute(JobExecutionContext jobExecutionContext) {
		 ...
		 try{
		    ...
		    logger.debug("ImportInvoiceTask"+":Process Task ...AT:"+new Date());
		    
		    /******** Action************/
		    ImportInvoiceTaskAction action = new ImportInvoiceTaskAction();
