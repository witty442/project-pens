	...
	protected static Logger logger = Logger.getLogger("PENS");
	 ...
	 public static ArrayList<References> findJobInitail(String rerun)throws Exception{
	        ...
	        try{            
	        	  ...
	        	  String sql ="select program_id ,program_name,type,rerun,visible from pensonline.scheduler_job_initial \n";
...
//            	logger.debug("limitPage : "+limitPage);
    ...
    private static BatchTaskDTO convertToBatchTaskDTO(ResultSet rs)throws Exception{
        ...
        logger.debug("update:"+rs.getDate("UPDATE_DATE"));
        dto.setUpdateDate(rs.getDate("UPDATE_DATE") != null?rs.getDate("UPDATE_DATE"):null);
