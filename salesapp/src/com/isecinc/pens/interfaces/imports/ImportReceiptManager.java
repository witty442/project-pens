...
public class ImportReceiptManager {
	...
	public MonitorBean process(User user) throws Exception{
		...
		try{
			...
			monitorModel.setName("Import Receipt");
			...
			monitorModel = new ImportReceiptProcess().importReceiptFileToDB(monitorModel.getTransactionId(),monitorModel.getMonitorId(),monitorModel.getTransactionType(), user, importAll);
