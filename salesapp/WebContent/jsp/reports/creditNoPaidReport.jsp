...
function gotoReport(path){
	...
	document.creditNoPaidReportForm.action = path + "/jsp/creditNoPaidReport.do?do=searchReport&rf=Y";
	document.creditNoPaidReportForm.submit();
	return true;
}

function clearForm(path){
	document.creditNoPaidReportForm.action = path + "/jsp/creditNoPaidReport.do?do=clearForm";
	document.creditNoPaidReportForm.submit();
	return true;
}
</script>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="CreditNoPaidReport"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/creditNoPaidReport">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								<td align="right">เรียกข้อมูลถึงวันที่<font color="red">*</font> </td>
								<td align="left">
