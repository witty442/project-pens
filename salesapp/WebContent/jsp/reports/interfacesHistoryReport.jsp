...
function search(path){
	...
	$(function(){
		var getData = $.ajax({
			url: "${pageContext.request.contextPath}/jsp/ajax/interfacesHistoryReportQuery.jsp",
			data : "dateOrder=" + $('#orderDate').val()
			,
			async: true,
...
function clearForm(path){
	window.location=path+"/jsp/interfacesHistoryReport.do";
}
</script>
</head>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="InterfaceHistoryReport" />
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
		            ...
		            <td bgcolor="#f8f8f8">
						...
						<table align="center" border="0" cellpadding="3" cellspacing="0" width="100%">
							...
							<tr>
								...
								<td align="left">
									<input type="text" id="orderDate" name="orderDate" readonly="readonly" size="15"/>
