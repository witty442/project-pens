...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sysconfig.js?v=<%=SessionGen.getInstance().getIdSession()%>"></script>
</head>
    	...
    	<td background="${pageContext.request.contextPath}/images2/content01.png" valign="top">
	    	...
	    	<!-- PROGRAM HEADER -->
	      	<jsp:include page="../program.jsp">
				<jsp:param name="function" value="SystemConf"/>
			</jsp:include>
	      	<!-- TABLE BODY -->
	      	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="txt1">
	      		<tr style="height: 9px;">
	      		...
	      		<tr>
		            ...
		            <td bgcolor="#f8f8f8">
						<!-- BODY -->
						<html:form action="/jsp/sysconfigAction">
						<jsp:include page="../error.jsp"/>
						<jsp:include page="sysconfig_info.jsp" />
						<!-- BUTTON -->
						<br>
